...
public final class MSEntityTypes
{
	...
	public static final RegistryObject<EntityType<DenizenEntity>> DENIZEN = REGISTER.register("denizen", () -> EntityType.Builder.<DenizenEntity>of(DenizenEntity::new, MobCategory.MISC).sized(/*12.0F, 10.5F*/15.0F, 22F).build(new ResourceLocation(Minestuck.MOD_ID, "denizen").toString()));
	...
	public static void onEntityAttributeCreation(EntityAttributeCreationEvent event)
	{
		...
		event.put(DENIZEN.get(), DenizenEntity.denizenAttributes().build());
