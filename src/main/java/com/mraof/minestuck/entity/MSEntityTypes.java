...
public final class MSEntityTypes
{
	...
	public static final RegistryObject<EntityType<DenizenEntity>> DENIZEN = REGISTER.register("denizen", () -> EntityType.Builder.<DenizenEntity>of(DenizenEntity::new, MobCategory.MISC).sized(12.0F, 10.5F).build(new ResourceLocation(Minestuck.MOD_ID, "denizen").toString()));
