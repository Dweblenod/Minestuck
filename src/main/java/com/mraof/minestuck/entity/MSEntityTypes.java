...
public final class MSEntityTypes
{
	...
	public static final RegistryObject<EntityType<DenizenEntity>> DENIZEN = REGISTER.register("denizen", () -> EntityType.Builder.<DenizenEntity>of(DenizenEntity::new, MobCategory.MISC).sized(8.0F, 11.0F).build(new ResourceLocation(Minestuck.MOD_ID, "denizen").toString()));
