...
public abstract class GodTierAbstractModel extends BipedModel
{
	//was public final EnumClass heroClass;
	public EnumClass heroClass;
	...
	public GodTierAbstractModel(int textWidth, int textHeight, EnumClass heroClass)
	{
	...
	private void renderBody(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(Minestuck.MOD_ID, "textures/models/armor/symbol/"+aspectName+".png"));
	...
	private void renderCape(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) //TODO cape anim
	{
		...
		AbstractClientPlayerEntity entitylivingbaseIn = (AbstractClientPlayerEntity) entityIn;
		...
		if (itemstack.getItem() != Items.ELYTRA)
		{
			...
			System.out.println(" cape angle: " + cape.rotateAngleX);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
	{
		...
		} else
		{
			...
			{
				RenderPlayer render = (RenderPlayer) Minecraft.getMinecraft().getRenderManager().<AbstractClientPlayerEntity>getEntityRenderObject(entityIn);
				PlayerModel modelPlayer = render.getMainModel();
	...
	public void addExtraInfo(EntityLivingBase entityLiving, ItemStack stack, EquipmentSlotType armorSlot)
	{
	
	}
}

//package com.cibernet.minestuckgodtier.models.armor;
//
