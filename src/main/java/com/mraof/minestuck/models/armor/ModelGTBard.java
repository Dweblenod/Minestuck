...
//Ciber imports below
//package com.cibernet.minestuckgodtier.models.armor;// Made with Blockbench 3.6.6
...
public class ModelGTBard extends GodTierAbstractModel
{
	...
	public ModelGTBard()
	{
		...
		head.cubeList.add(new ModelBox(head, 18, 36, -4.0F, -10.0F, 4.0F, 8, 1, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 36, -4.0F, -10.0F, -5.0F, 8, 1, 1, 0.0F, false));

		hood = new ModelRenderer(this);
		hood.setRotationPoint(0.0F, -10.0F, 0.0F);
		head.addChild(hood);
		hood.cubeList.add(new ModelBox(hood, 96, 9, -4.0F, -1.0F, -4.0F, 8, 2, 8, 0.5F, false));
		hood.cubeList.add(new ModelBox(hood, 96, 19, -4.0F, -3.0F, -4.0F, 8, 3, 8, 0.0F, false));
		hood.cubeList.add(new ModelBox(hood, 104, 30, -3.0F, -4.0F, -3.0F, 6, 1, 6, 0.5F, false));
		hood.cubeList.add(new ModelBox(hood, 104, 37, -3.0F, -6.0F, -3.0F, 6, 3, 6, 0.0F, false));
		hood.cubeList.add(new ModelBox(hood, 112, 46, -2.0F, -7.0F, -2.0F, 4, 1, 4, 0.5F, false));
		hood.cubeList.add(new ModelBox(hood, 112, 51, -2.0F, -9.0F, -2.0F, 4, 3, 4, 0.0F, false));
		hood.cubeList.add(new ModelBox(hood, 120, 58, -1.0F, -9.0F, -1.0F, 2, 1, 2, 0.5F, false));
		hood.cubeList.add(new ModelBox(hood, 120, 61, -1.0F, -10.0F, -1.0F, 2, 1, 2, 0.0F, false));
