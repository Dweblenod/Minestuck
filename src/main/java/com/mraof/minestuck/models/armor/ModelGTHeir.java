...
/*public class ModelGTHeir extends GodTierAbstractModel
{
	...
	public ModelGTHeir()
	{
		...
		head.cubeList.add(new ModelBox(head, 0, 0, -5.0F, -25.0F+24, -5.0F, 10, 1, 10, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 22, 11, -5.0F, -33.0F+24, 4.0F, 10, 8, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 11, -5.0F, -33.0F+24, -5.0F, 10, 8, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 20, -5.0F, -33.0F+24, -4.0F, 1, 8, 8, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 18, 20, 4.0F, -33.0F+24, -4.0F, 1, 8, 8, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 40, 2, -5.0F, -34.0F+24, -4.0F, 10, 1, 8, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 36, -4.0F, -34.0F+24, -5.0F, 8, 1, 1, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 18, 36, -4.0F, -34.0F+24, 4.0F, 8, 1, 2, 0.0F, false));
