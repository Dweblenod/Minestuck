...
public class MSItems
{
	...
	//Hammers
	public static final DeferredItem<Item> CLAW_HAMMER = REGISTER.register("claw_hammer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.8F).efficiency(1.0F).set(HAMMER_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> SLEDGE_HAMMER = REGISTER.register("sledge_hammer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -3.2F).efficiency(4.0F).set(HAMMER_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> MAILBOX = REGISTER.register("mailbox", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 4, -3.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> BLACKSMITH_HAMMER = REGISTER.register("blacksmith_hammer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -3.2F).efficiency(3.5F).set(HAMMER_TOOL), new Item.Properties().defaultDurability(450)));
	public static final DeferredItem<Item> POGO_HAMMER = REGISTER.register("pogo_hammer", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 5, -3.2F).efficiency(2.0F).set(HAMMER_TOOL).set(PogoEffect.EFFECT_07).add(PogoEffect.EFFECT_07), new Item.Properties()));
	public static final DeferredItem<Item> WRINKLEFUCKER = REGISTER.register("wrinklefucker", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 7, -3.2F).efficiency(2.0F).set(HAMMER_TOOL).set(PogoEffect.EFFECT_04).add(PogoEffect.EFFECT_04), new Item.Properties()));
	public static final DeferredItem<Item> TELESCOPIC_SASSACRUSHER = REGISTER.register("telescopic_sassacrusher", () -> new WeaponItem(new WeaponItem.Builder(BOOK_TIER, 11, -3.4F).efficiency(5.0F).set(HAMMER_TOOL), new Item.Properties().defaultDurability(1024)));
	public static final DeferredItem<Item> DEMOCRATIC_DEMOLITIONER = REGISTER.register("democratic_demolitioner", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -3.0F).efficiency(1.0F).set(HAMMER_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> BOOMBOX_BEATER = REGISTER.register("boombox_beater", () -> new MusicPlayerWeapon(new WeaponItem.Builder(Tiers.IRON, 7, -3.2F).efficiency(4.0F).set(HAMMER_TOOL), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> REGI_HAMMER = REGISTER.register("regi_hammer", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 7, -3.2F).efficiency(8.0F).set(HAMMER_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> FEAR_NO_ANVIL = REGISTER.register("fear_no_anvil", () -> new WeaponItem(new WeaponItem.Builder(DENIZEN_TIER, 7, -3.2F).efficiency(7.0F).set(HAMMER_TOOL).add(OnHitEffect.TIME_SLOWNESS_AOE).add(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1))), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> MELT_MASHER = REGISTER.register("melt_masher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 8, -3.2F).efficiency(12.0F).set(HAMMER_TOOL).add(OnHitEffect.setOnFire(25)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ESTROGEN_EMPOWERED_EVERYTHING_ERADICATOR = REGISTER.register("estrogen_empowered_everything_eradicator", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -3.2F).efficiency(9.0F).set(MULTI_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 200)).set(PogoEffect.EFFECT_07).add(PogoEffect.EFFECT_07), new Item.Properties().defaultDurability(6114)));
	public static final DeferredItem<Item> EEEEEEEEEEEE = REGISTER.register("eeeeeeeeeeee", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 9, -3.2F).efficiency(9.1F).set(HAMMER_TOOL).set(PogoEffect.EFFECT_02).add(PogoEffect.EFFECT_02).add(OnHitEffect.playSound(MSSoundEvents.ITEM_EEEEEEEEEEEE_HIT, 1.5F, 1.0F)), new Item.Properties().defaultDurability(6114)));
	public static final DeferredItem<Item> ZILLYHOO_HAMMER = REGISTER.register("zillyhoo_hammer", () -> new WeaponItem(new WeaponItem.Builder(ZILLY_TIER, 8, -3.2F).efficiency(15.0F).set(HAMMER_TOOL), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> POPAMATIC_VRILLYHOO = REGISTER.register("popamatic_vrillyhoo", () -> new WeaponItem(new WeaponItem.Builder(ZILLY_TIER, 6, -3.2F).efficiency(15.0F).set(HAMMER_TOOL).add(OnHitEffect.RANDOM_DAMAGE), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> SCARLET_ZILLYHOO = REGISTER.register("scarlet_zillyhoo", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 9, -3.2F).efficiency(4.0F).set(HAMMER_TOOL).add(OnHitEffect.setOnFire(50)), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> MWRTHWL = REGISTER.register("mwrthwl", () -> new WeaponItem(new WeaponItem.Builder(WELSH_TIER, 8, -3.2F).efficiency(4.0F).set(HAMMER_TOOL), new Item.Properties().rarity(Rarity.EPIC)));
	
	
	//Blades
	public static final DeferredItem<Item> SORD = REGISTER.register("sord", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 3, -3.0F).efficiency(1.0F).set(SWORD_TOOL).remove(ToolActions.SWORD_SWEEP).add(OnHitEffect.SORD_DROP), new Item.Properties()));
	public static final DeferredItem<Item> PAPER_SWORD = REGISTER.register("paper_sword", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 2, -2.4F).efficiency(3.0F).set(SWORD_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> SWONGE = REGISTER.register("swonge", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.4F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.absorbFluid(() -> Blocks.WATER, MSItems.WET_SWONGE)), new Item.Properties()));
	public static final DeferredItem<Item> WET_SWONGE = REGISTER.register("wet_swonge", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.6F).efficiency(1.0F).set(MISC_TOOL).set(RightClickBlockEffect.placeFluid(() -> Blocks.WATER, MSItems.SWONGE)).add(OnHitEffect.playSound(() -> SoundEvents.GUARDIAN_FLOP)), new Item.Properties()));
	public static final DeferredItem<Item> PUMORD = REGISTER.register("pumord", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 3, -2.4F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.absorbFluid(() -> Blocks.LAVA, MSItems.WET_PUMORD)), new Item.Properties()));
	public static final DeferredItem<Item> WET_PUMORD = REGISTER.register("wet_pumord", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 3, -2.6F).efficiency(1.0F).set(MISC_TOOL).set(RightClickBlockEffect.placeFluid(() -> Blocks.LAVA, MSItems.PUMORD)).add(OnHitEffect.playSound(() -> SoundEvents.BUCKET_EMPTY_LAVA, 1.0F, 0.2F)).add(OnHitEffect.setOnFire(10)), new Item.Properties()));
	public static final DeferredItem<Item> CACTACEAE_CUTLASS = REGISTER.register("cactaceae_cutlass", () -> new WeaponItem(new WeaponItem.Builder(CACTUS_TIER, 3, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties())); //The sword harvestTool is only used against webs, hence the high efficiency.
	public static final DeferredItem<Item> STEAK_SWORD = REGISTER.register("steak_sword", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 4, -2.4F).efficiency(5.0F).set(SWORD_TOOL).setEating(FinishUseItemEffect.foodEffect(8, 1F)), new Item.Properties().defaultDurability(250)));
	public static final DeferredItem<Item> BEEF_SWORD = REGISTER.register("beef_sword", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 2, -2.4F).efficiency(5.0F).set(SWORD_TOOL).setEating(FinishUseItemEffect.foodEffect(3, 0.8F, 75)), new Item.Properties()));
	public static final DeferredItem<Item> IRRADIATED_STEAK_SWORD = REGISTER.register("irradiated_steak_sword", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 5, -2.4F).efficiency(5.0F).set(SWORD_TOOL).setEating(FinishUseItemEffect.potionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1), 0.9F), FinishUseItemEffect.foodEffect(4, 0.4F, 25)), new Item.Properties().defaultDurability(300)));
	public static final DeferredItem<Item> MACUAHUITL = REGISTER.register("macuahuitl", () -> new WeaponItem(new WeaponItem.Builder(PRISMARINE_TIER, 3, -2.4F).efficiency(1.0F).set(SWORD_TOOL), new Item.Properties().defaultDurability(100)));
	public static final DeferredItem<Item> FROSTY_MACUAHUITL = REGISTER.register("frosty_macuahuitl", () -> new WeaponItem(new WeaponItem.Builder(ICE_TIER, 6, -2.4F).efficiency(1.0F).set(SWORD_TOOL).add(OnHitEffect.ICE_SHARD), new Item.Properties().defaultDurability(200)));
	public static final DeferredItem<Item> KATANA = REGISTER.register("katana", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> UNBREAKABLE_KATANA = REGISTER.register("unbreakable_katana", () -> new WeaponItem(new WeaponItem.Builder(ZILLY_TIER, 6, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().defaultDurability(-1).rarity(Rarity.RARE))); //Actually unbreakable
	public static final DeferredItem<Item> ANGEL_APOCALYPSE = REGISTER.register("angel_apocalypse", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.4F).efficiency(15.0F).set(SWORD_TOOL).add(OnHitEffect.HOPE_RESISTANCE), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> FIRE_POKER = REGISTER.register("fire_poker", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.4F).efficiency(15.0F).set(SWORD_TOOL).add(OnHitEffect.setOnFire(30)), new Item.Properties()));
	public static final DeferredItem<Item> TOO_HOT_TO_HANDLE = REGISTER.register("too_hot_to_handle", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(15.0F).set(SWORD_TOOL).add(OnHitEffect.setOnFire(10)), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> CALEDSCRATCH = REGISTER.register("caledscratch", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> CALEDFWLCH = REGISTER.register("caledfwlch", () -> new WeaponItem(new WeaponItem.Builder(WELSH_TIER, 6, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> ROYAL_DERINGER = REGISTER.register("royal_deringer", () -> new WeaponItem(new WeaponItem.Builder(DENIZEN_TIER, 7, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> CLAYMORE = REGISTER.register("claymore", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.6F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> CUTLASS_OF_ZILLYWAIR = REGISTER.register("cutlass_of_zillywair", () -> new WeaponItem(new WeaponItem.Builder(ZILLY_TIER, 6, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> REGISWORD = REGISTER.register("regisword", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 5, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CRUEL_FATE_CRUCIBLE = REGISTER.register("cruel_fate_crucible", () -> new WeaponItem(new WeaponItem.Builder(DENIZEN_TIER, 4, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().defaultDurability(4096).rarity(Rarity.RARE))); //Special property in ServerEventHandler
	public static final DeferredItem<Item> SCARLET_RIBBITAR = REGISTER.register("scarlet_ribbitar", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 7, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> DOGG_MACHETE = REGISTER.register("dogg_machete", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().defaultDurability(1000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> COBALT_SABRE = REGISTER.register("cobalt_sabre", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 7, -2.4F).efficiency(15.0F).set(SWORD_TOOL).add(OnHitEffect.setOnFire(30)), new Item.Properties().defaultDurability(300)));
	public static final DeferredItem<Item> QUANTUM_SABRE = REGISTER.register("quantum_sabre", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 4, -2.4F).efficiency(15.0F).set(SWORD_TOOL).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1)))), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> SHATTER_BEACON = REGISTER.register("shatter_beacon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -2.4F).efficiency(15.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> SHATTER_BACON = REGISTER.register("shatter_bacon", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 7, -2.4F).efficiency(5.0F).set(SWORD_TOOL).add(OnHitEffect.SORD_DROP), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> SUBTRACTSHUMIDIRE_ZOMORRODNEGATIVE = REGISTER.register("subtractshumidire_zomorrodnegative", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 6, -2.6F).efficiency(5.0F).set(SWORD_TOOL).add(OnHitEffect.setOnFire(30)), new Item.Properties()));
	public static final DeferredItem<Item> MUSIC_SWORD = REGISTER.register("music_sword", () -> new MusicPlayerWeapon(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.4F).efficiency(5.0F).set(SWORD_TOOL), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> PILLOW_TALK = REGISTER.register("pillow_talk", () -> new WeaponItem(new WeaponItem.Builder(ZILLY_TIER, 6, -2.4F).efficiency(15.0F).set(SWORD_TOOL).add(OnHitEffect.setOnFire(10)), new Item.Properties().defaultDurability(2031).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> KRAKENS_EYE = REGISTER.register("krakens_eye", () -> new WeaponItem(new WeaponItem.Builder(PRISMARINE_TIER, 5, -2.6F).efficiency(15.0F).set(SWORD_TOOL).set(ItemRightClickEffect.playerPotionEffect(() -> new MobEffectInstance(MobEffects.CONDUIT_POWER, 120, 0), 1, 120)), new Item.Properties().defaultDurability(650)));
	public static final DeferredItem<Item> CINNAMON_SWORD = REGISTER.register("cinnamon_sword", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 4, -2.4F).efficiency(1.0F).set(SWORD_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> UNION_BUSTER = REGISTER.register("union_buster", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 9, -3.5F).efficiency(1.0f).set(SWORD_TOOL).remove(ToolActions.SWORD_SWEEP).add(OnHitEffect.sweepMultiEffect(OnHitEffect.SPREADING_KNOCKBACK, OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MSEffects.SUSPICION.get(), 1200, 3, false, false)))), new Item.Properties().defaultDurability(505).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CHAINSAW_KATANA = REGISTER.register("chainsaw_katana", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.4F).efficiency(3.0F).set(AXE_TOOL), new Item.Properties().defaultDurability(700)));
	public static final DeferredItem<Item> THORN_IN_YOUR_SIDE = REGISTER.register("thorn_in_your_side", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.4F).efficiency(1.0F).set(SWORD_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> ROSE_PROTOCOL = REGISTER.register("rose_protocol", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.4F).efficiency(1.0F).set(SWORD_TOOL).add(OnHitEffect.setOnFire(6)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	
	
	//Knives
	public static final DeferredItem<Item> DAGGER = REGISTER.register("dagger", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(3)), new Item.Properties()));
	public static final DeferredItem<Item> DIAMOND_DAGGER = REGISTER.register("diamond_dagger", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 0, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)), new Item.Properties()));
	public static final DeferredItem<Item> PIGLINS_PRIDE = REGISTER.register("piglins_pride", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 0, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)).add(OnHitEffect.targetSpecificAdditionalDamage(4, () -> EntityType.PIGLIN)), new Item.Properties().fireResistant()));
	public static final DeferredItem<Item> BASILISK_BREATH_DRAGONSLAYER = REGISTER.register("basilisk_breath_dragonslayer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 1, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)).add(OnHitEffect.targetSpecificAdditionalDamage(6, MSEntityTypes.BASILISK)), new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> HALLOWED_SKEWER = REGISTER.register("hallowed_skewer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(9)), new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> GENESIS_GODSTABBER = REGISTER.register("genesis_godstabber", () -> new WeaponItem(new WeaponItem.Builder(WELSH_TIER, 1, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(9)), new Item.Properties().defaultDurability(1561).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> NIFE = REGISTER.register("nife", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 1, -2.0F).add(OnHitEffect.SORD_DROP), new Item.Properties()));
	public static final DeferredItem<Item> LIGHT_OF_MY_KNIFE = REGISTER.register("light_of_my_knife", () -> new WeaponItem(new WeaponItem.Builder(EMERALD_TIER, 1, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)).add(OnHitEffect.setOnFire(35)), new Item.Properties()));
	public static final DeferredItem<Item> THOUSAND_DEGREE_KNIFE = REGISTER.register("thousand_degree_knife", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 0, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)).add(OnHitEffect.setOnFire(35)), new Item.Properties().fireResistant()));
	public static final DeferredItem<Item> STARSHARD_TRI_BLADE = REGISTER.register("starshard_tri_blade", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 1, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(9)), new Item.Properties()));
	public static final DeferredItem<Item> TOOTHRIPPER = REGISTER.register("toothripper", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)), new Item.Properties().defaultDurability(1200)));
	public static final DeferredItem<Item> SHADOWRAZOR = REGISTER.register("shadowrazor", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(1500)));
	public static final DeferredItem<Item> PRINCESS_PERIL = REGISTER.register("princess_peril", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 5, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.backstab(4)).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(1650)));
	
	
	//Keys
	public static final DeferredItem<Item> HOUSE_KEY = REGISTER.register("house_key", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> KEYBLADE = REGISTER.register("keyblade", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CANDY_KEY = REGISTER.register("candy_key", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> LOCKSOFTENER = REGISTER.register("locksoftener", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> BISEKEYAL = REGISTER.register("bisekeyal", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(450)));
	public static final DeferredItem<Item> LATCHMELTER = REGISTER.register("latchmelter", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.setOnFire(6)), new Item.Properties().defaultDurability(450)));
	public static final DeferredItem<Item> KEY_TO_THE_MACHINE = REGISTER.register("key_to_the_machine", () -> new WeaponItem(new WeaponItem.Builder(EMERALD_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> KEY_TO_THE_CITY = REGISTER.register("key_to_the_city", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(650).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> INNER_HEART = REGISTER.register("inner_heart", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.spawnParticles(ParticleTypes.HEART, 15, 2.0, 1.0, 2.0, 2.0)), new Item.Properties().defaultDurability(460)));
	public static final DeferredItem<Item> CRIMSON_LEAP = REGISTER.register("crimson_leap", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 2, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2100).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> LOCH_PICK = REGISTER.register("loch_pick", () -> new WeaponItem(new WeaponItem.Builder(HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> DRAGON_KEY = REGISTER.register("dragon_key", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> TRUE_BLUE = REGISTER.register("true_blue", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.RANDOM_DAMAGE), new Item.Properties().defaultDurability(888)));
	public static final DeferredItem<Item> BLUE_BEAMS = REGISTER.register("blue_beams", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.RANDOM_DAMAGE), new Item.Properties().defaultDurability(1616)));
	public static final DeferredItem<Item> INKSPLOCKER_UNLOCKER = REGISTER.register("inksplocker_unlocker", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 2, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties()));
	public static final DeferredItem<Item> INKSQUIDDER_DEPTHKEY = REGISTER.register("inksquidder_depthkey", () -> new WeaponItem(new WeaponItem.Builder(PRISMARINE_TIER, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties()));
	public static final DeferredItem<Item> REGIKEY = REGISTER.register("regikey", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 2, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CLOCKKEEPER = REGISTER.register("clockkeeper", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(3500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> HOME_BY_MIDNIGHT = REGISTER.register("home_by_midnight", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(PogoEffect.EFFECT_07).add(PogoEffect.EFFECT_07), new Item.Properties().defaultDurability(4000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> NO_TIME_FOR_FLIES = REGISTER.register("no_time_for_flies", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 3, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> NATURES_HEART = REGISTER.register("natures_heart", () -> new WeaponItem(new WeaponItem.Builder(CACTUS_TIER, 4, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2005)));
	public static final DeferredItem<Item> YALDABAOTHS_KEYTON = REGISTER.register("yaldabaoths_keyton", () -> new WeaponItem(new WeaponItem.Builder(DENIZEN_TIER, 3, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.BOSS_BUSTER).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA)), new Item.Properties().defaultDurability(4000).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> KEYTAR = REGISTER.register("keytar", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.playSound(SoundEvents.NOTE_BLOCK_GUITAR::value)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 10, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(265)));
	public static final DeferredItem<Item> ALLWEDDOL = REGISTER.register("allweddol", () -> new WeaponItem(new WeaponItem.Builder(WELSH_TIER, 6, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	
	
	//Batons
	public static final DeferredItem<Item> CONDUCTORS_BATON = REGISTER.register("conductors_baton", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.0F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 10, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(200)));
	public static final DeferredItem<Item> SHARP_NOTE = REGISTER.register("sharp_note", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 2.0F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 12, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> URANIUM_BATON = REGISTER.register("uranium_baton", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.8F)).add(OnHitEffect.spawnParticles(ParticleTypes.ITEM_SLIME, 10, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(285)));
	public static final DeferredItem<Item> WIND_WAKER = REGISTER.register("wind_waker", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).add(OnHitEffect.enemyKnockback(1.3F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 8, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(750)));
	public static final DeferredItem<Item> CELESTIAL_FULCRUM = REGISTER.register("celestial_fulcrum", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.5F)).add(OnHitEffect.spawnParticles(ParticleTypes.NOTE, 14, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(1200)));
	public static final DeferredItem<Item> HYMN_FOR_HORRORTERRORS = REGISTER.register("hymn_for_horrorterrors", () -> new WeaponItem(new WeaponItem.Builder(HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.HORRORTERROR).set(MagicRangedRightClickEffect.HORRORTERROR_MAGIC).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.2F)).add(OnHitEffect.spawnParticles(ParticleTypes.SCULK_SOUL, 15, 1.0, 2.0, 1.0, 2.0)), new Item.Properties().defaultDurability(2500).rarity(Rarity.RARE)));
	
	
	//Axes
	public static final DeferredItem<Item> BATLEACKS = REGISTER.register("batleacks", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 3, -3.5F).efficiency(1.0F).dontDisableShield().set(AXE_TOOL).add(OnHitEffect.SORD_DROP), new Item.Properties()));
	public static final DeferredItem<Item> COPSE_CRUSHER = REGISTER.register("copse_crusher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 5, -3.0F).efficiency(6.0F).set(AXE_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 20)), new Item.Properties().defaultDurability(400)));
	public static final DeferredItem<Item> QUENCH_CRUSHER = REGISTER.register("quench_crusher", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 7, -3.0F).efficiency(2.0F).set(AXE_TOOL).setEating(FinishUseItemEffect.foodEffect(6, 0.6F, 75)), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> MELONSBANE = REGISTER.register("melonsbane", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 8, -3.0F).efficiency(3.0F).set(AXE_TOOL).set(DestroyBlockEffect.extraHarvests(true, 0.6F, 20, () -> Items.MELON_SLICE, () -> Blocks.MELON)), new Item.Properties().defaultDurability(400)));
	public static final DeferredItem<Item> CROP_CHOP = REGISTER.register("crop_chop", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 7, -3.0F).efficiency(3.0F).set(AXE_TOOL).set(DestroyBlockEffect.DOUBLE_FARM), new Item.Properties().defaultDurability(800)));
	public static final DeferredItem<Item> THE_LAST_STRAW = REGISTER.register("the_last_straw", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 9, -3.0F).efficiency(3.0F).set(AXE_TOOL).set(DestroyBlockEffect.DOUBLE_FARM), new Item.Properties().defaultDurability(950)));
	public static final DeferredItem<Item> BATTLEAXE = REGISTER.register("battleaxe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(3.0F).set(AXE_TOOL), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> CANDY_BATTLEAXE = REGISTER.register("candy_battleaxe", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 8, -3.0F).efficiency(2.0F).set(AXE_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties().defaultDurability(111)));
	public static final DeferredItem<Item> CHOCO_LOCO_WOODSPLITTER = REGISTER.register("choco_loco_woodsplitter", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 9, -3.0F).efficiency(2.0F).set(AXE_TOOL).setEating(FinishUseItemEffect.foodEffect(8, 0.4F)), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> STEEL_EDGE_CANDYCUTTER = REGISTER.register("steel_edge_candycutter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(3.0F).set(AXE_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties().defaultDurability(800).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> BLACKSMITH_BANE = REGISTER.register("blacksmith_bane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 8, -3.0F).efficiency(6.0F).set(AXE_TOOL), new Item.Properties().defaultDurability(413)));
	public static final DeferredItem<Item> REGIAXE = REGISTER.register("regiaxe", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 6, -3.0F).efficiency(6.0F).set(AXE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> GOTHY_AXE = REGISTER.register("gothy_axe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(6.0F).set(AXE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> SURPRISE_AXE = REGISTER.register("surprise_axe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -3.0F).efficiency(6.0F).set(AXE_TOOL).add(OnHitEffect.KUNDLER_SURPRISE), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> SHOCK_AXE = REGISTER.register("shock_axe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(6.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.SHOCK_AXE_UNPOWERED)).add(OnHitEffect.DROP_FOE_ITEM).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties().defaultDurability(800)));
	public static final DeferredItem<Item> SHOCK_AXE_UNPOWERED = REGISTER.register("shock_axe_unpowered", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(6.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.SHOCK_AXE)), new Item.Properties().defaultDurability(800)));
	public static final DeferredItem<Item> SCRAXE = REGISTER.register("scraxe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(7.0F).set(AXE_TOOL), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> LORENTZ_DISTRANSFORMATIONER = REGISTER.register("lorentz_distransformationer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -3.0F).efficiency(7.0F).set(AXE_TOOL).add(OnHitEffect.SPACE_TELEPORT), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> PISTON_POWERED_POGO_AXEHAMMER = REGISTER.register("piston_powered_pogo_axehammer", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 6, -3.0F).efficiency(2.0F).set(AXE_HAMMER_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 50)).set(PogoEffect.EFFECT_06).add(PogoEffect.EFFECT_06), new Item.Properties().defaultDurability(800)));
	public static final DeferredItem<Item> RUBY_CROAK = REGISTER.register("ruby_croak", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 8, -3.0F).efficiency(8.0F).set(AXE_TOOL), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> HEPHAESTUS_LUMBERJACK = REGISTER.register("hephaestus_lumberjack", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 7, -3.0F).efficiency(9.0F).set(AXE_TOOL).add(OnHitEffect.setOnFire(30)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> FISSION_FOCUSED_FAULT_FELLER = REGISTER.register("fission_focused_fault_feller", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -3.0F).efficiency(5.0F).set(AXE_HAMMER_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 100)).set(PogoEffect.EFFECT_07).add(PogoEffect.EFFECT_07), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> BISECTOR = REGISTER.register("bisector", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 9, -3.2F).efficiency(5.0F).set(AXE_TOOL), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> FINE_CHINA_AXE = REGISTER.register("fine_china_axe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 9, -3.2F).efficiency(1.0F).set(AXE_TOOL), new Item.Properties().defaultDurability(8)));
	...
	//Claws
	public static final DeferredItem<Item> MAKESHIFT_CLAWS_DRAWN = REGISTER.register("makeshift_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 1, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.MAKESHIFT_CLAWS_SHEATHED)), new Item.Properties().defaultDurability(200)));
	...
	public static final DeferredItem<Item> CAT_CLAWS_DRAWN = REGISTER.register("cat_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.CAT_CLAWS_SHEATHED)), new Item.Properties().defaultDurability(500)));
	...
	public static final DeferredItem<Item> COFFEE_CLAWS_DRAWN = REGISTER.register("coffee_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 2, -1.5F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.COFFEE_CLAWS_SHEATHED)), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> COFFEE_CLAWS_SHEATHED = REGISTER.register("coffee_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, -1, -1.0F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.COFFEE_CLAWS_DRAWN)), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> POGO_CLAWS = REGISTER.register("pogo_claws", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 2, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(PogoEffect.EFFECT_07).add(PogoEffect.EFFECT_07), new Item.Properties()));
	public static final DeferredItem<Item> ATOMIKITTY_KATAR_DRAWN = REGISTER.register("atomikitty_katar_drawn", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 1, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ATOMIKITTY_KATAR_SHEATHED)).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1)))), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> ATOMIKITTY_KATAR_SHEATHED = REGISTER.register("atomikitty_katar_sheathed", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, -1, -1.0F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.ATOMIKITTY_KATAR_DRAWN)), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> SKELETONIZER_DRAWN = REGISTER.register("skeletonizer_drawn", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 5, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.SKELETONIZER_SHEATHED)), new Item.Properties().defaultDurability(750)));
	public static final DeferredItem<Item> SKELETONIZER_SHEATHED = REGISTER.register("skeletonizer_sheathed", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, -1, -1.0F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.SKELETONIZER_DRAWN)), new Item.Properties().defaultDurability(750)));
	public static final DeferredItem<Item> SKELETON_DISPLACER_DRAWN = REGISTER.register("skeleton_displacer_drawn", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 6, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.SKELETON_DISPLACER_SHEATHED)).add(OnHitEffect.targetSpecificAdditionalDamage(4, () -> EntityType.SKELETON)), new Item.Properties().defaultDurability(1250)));
	public static final DeferredItem<Item> SKELETON_DISPLACER_SHEATHED = REGISTER.register("skeleton_displacer_sheathed", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, -1, -1.0F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.SKELETON_DISPLACER_DRAWN)), new Item.Properties().defaultDurability(1250)));
	public static final DeferredItem<Item> TEARS_OF_THE_ENDERLICH_DRAWN = REGISTER.register("tears_of_the_enderlich_drawn", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 4, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.TEARS_OF_THE_ENDERLICH_SHEATHED)).add(OnHitEffect.targetSpecificAdditionalDamage(6, MSEntityTypes.LICH)), new Item.Properties().defaultDurability(2000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> TEARS_OF_THE_ENDERLICH_SHEATHED = REGISTER.register("tears_of_the_enderlich_sheathed", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, -4, -1.0F).efficiency(10.0F).set(ItemRightClickEffect.switchTo(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN)), new Item.Properties().defaultDurability(2000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> LION_LACERATORS_DRAWN = REGISTER.register("lion_lacerators_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 4, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.LION_LACERATORS_SHEATHED)).add(OnHitEffect.targetSpecificAdditionalDamage(4, MSEntityTypes.LICH)), new Item.Properties().defaultDurability(2031).rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> ACTION_CLAWS_DRAWN = REGISTER.register("action_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -1.5F).efficiency(10.0F).set(CLAWS_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ACTION_CLAWS_SHEATHED)), new Item.Properties().defaultDurability(4096).rarity(Rarity.RARE)));
	...
	//Chainsaws
	public static final DeferredItem<Item> LIPSTICK_CHAINSAW = REGISTER.register("lipstick_chainsaw", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.LIPSTICK)), new Item.Properties().defaultDurability(250)));
	...
	public static final DeferredItem<Item> CAKESAW = REGISTER.register("cakesaw", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 3, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.CAKESAW_LIPSTICK)).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	...
	public static final DeferredItem<Item> MAGENTA_MAULER = REGISTER.register("magenta_mauler", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 5, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.MAGENTA_MAULER_LIPSTICK)), new Item.Properties().defaultDurability(500)));
	...
	public static final DeferredItem<Item> THISTLEBLOWER = REGISTER.register("thistleblower", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 4, -1.0F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.THISTLEBLOWER_LIPSTICK)), new Item.Properties().defaultDurability(500)));
	...
	public static final DeferredItem<Item> HAND_CRANKED_VAMPIRE_ERASER = REGISTER.register("hand_cranked_vampire_eraser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 4, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.HAND_CRANKED_VAMPIRE_ERASER_LIPSTICK)), new Item.Properties().defaultDurability(250)));
	...
	public static final DeferredItem<Item> EMERALD_IMMOLATOR = REGISTER.register("emerald_immolator", () -> new WeaponItem(new WeaponItem.Builder(EMERALD_TIER, 3, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.EMERALD_IMMOLATOR_LIPSTICK)).add(OnHitEffect.setOnFire(5)), new Item.Properties().defaultDurability(1024)));
	...
	public static final DeferredItem<Item> OBSIDIATOR = REGISTER.register("obsidiator", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 4, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.OBSIDIATOR_LIPSTICK)), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> DEVILS_DELIGHT = REGISTER.register("devils_delight", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 3, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.DEVILS_DELIGHT_LIPSTICK)).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(1536).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> DEMONBANE_RAGRIPPER = REGISTER.register("demonbane_ragripper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 3, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.DEMONBANE_RAGRIPPER_LIPSTICK)).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(2048).rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> FROSTTOOTH = REGISTER.register("frosttooth", () -> new WeaponItem(new WeaponItem.Builder(ICE_TIER, 5, -1.5F).efficiency(10.0F).set(AXE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.FROSTTOOTH_LIPSTICK)).add(OnHitEffect.ICE_SHARD), new Item.Properties().defaultDurability(1536)));
	...
	//Lances
	public static final DeferredItem<Item> WOODEN_LANCE = REGISTER.register("wooden_lance", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 4, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> LANEC = REGISTER.register("lanec", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 3, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.SORD_DROP), new Item.Properties()));
	public static final DeferredItem<Item> JOUSTING_LANCE = REGISTER.register("jousting_lance", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> POGO_LANCE = REGISTER.register("pogo_lance", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 4, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.mutualKnockback(0.75F)), new Item.Properties()));
	public static final DeferredItem<Item> LANCELOTS_LOLLY = REGISTER.register("lancelots_lolly", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> DRAGON_LANCE = REGISTER.register("dragon_lance", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> SKY_PIERCER = REGISTER.register("sky_piercer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.setOnFire(30)), new Item.Properties().fireResistant()));
	public static final DeferredItem<Item> FIDUSPAWN_LANCE = REGISTER.register("fiduspawn_lance", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2500)));
	public static final DeferredItem<Item> REGILANCE = REGISTER.register("regilance", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CIGARETTE_LANCE = REGISTER.register("cigarette_lance", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.RANDOM_DAMAGE), new Item.Properties().rarity(Rarity.UNCOMMON)));
	
	public static final DeferredItem<Item> LUCERNE_HAMMER = REGISTER.register("lucerne_hammer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.5F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> LUCERNE_HAMMER_OF_UNDYING = REGISTER.register("lucerne_hammer_of_undying", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.5F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON))); //Special property in ServerEventHandler
	
	public static final DeferredItem<Item> OBSIDIAN_AXE_KNIFE = REGISTER.register("obsidian_axe_knife", () -> new WeaponItem(new WeaponItem.Builder(PRISMARINE_TIER, 2, -2.0F).efficiency(1.5F).set(MISC_TOOL), new Item.Properties().durability(100)));
	
	
	//Fans
	public static final DeferredItem<Item> FAN = REGISTER.register("fan", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)), new Item.Properties()));
	public static final DeferredItem<Item> CANDY_FAN = REGISTER.register("candy_fan", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> SPINES_OF_FLUTHLU = REGISTER.register("spines_of_fluthlu", () -> new WeaponItem(new WeaponItem.Builder(HORRORTERROR_TIER, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)).add(OnHitEffect.HORRORTERROR), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> RAZOR_FAN = REGISTER.register("razor_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)), new Item.Properties()));
	public static final DeferredItem<Item> MOTOR_FAN = REGISTER.register("motor_fan", () -> new WeaponItem(new WeaponItem.Builder(CORUNDUM_TIER, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(2.0F)), new Item.Properties()));
	public static final DeferredItem<Item> ATOMIC_VAPORIZER = REGISTER.register("atomic_vaporizer", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(2.0F)).add(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1))), new Item.Properties().defaultDurability(2048)));
	public static final DeferredItem<Item> SHAVING_FAN = REGISTER.register("shaving_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)), new Item.Properties()));
	public static final DeferredItem<Item> FIRESTARTER = REGISTER.register("firestarter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).add(OnHitEffect.enemyKnockback(1.5F)).add(OnHitEffect.setOnFire(35)), new Item.Properties().durability(300)));
	public static final DeferredItem<Item> STAR_RAY = REGISTER.register("star_ray", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).add(OnHitEffect.enemyKnockback(1.5F)).add(OnHitEffect.setOnFire(35)), new Item.Properties()));
	public static final DeferredItem<Item> TYPHONIC_TRIVIALIZER = REGISTER.register("typhonic_trivializer", () -> new WeaponItem(new WeaponItem.Builder(DENIZEN_TIER, 2, -1.0F).efficiency(1.5F).set(MISC_TOOL).set(ItemRightClickEffect.extinguishFire(3)).add(OnHitEffect.BREATH_LEVITATION_AOE).add(OnHitEffect.enemyKnockback(2.0F)), new Item.Properties().rarity(Rarity.RARE)));
	
	
	//Sickles
	public static final DeferredItem<Item> SICKLE = REGISTER.register("sickle", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.2F).efficiency(1.5F).set(SICKLE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> BISICKLE = REGISTER.register("bisickle", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.2F).efficiency(1.5F).set(SICKLE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> OW_THE_EDGE = REGISTER.register("ow_the_edge", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 3, -3.0F).efficiency(1.0F).dontDisableShield().set(SICKLE_TOOL).add(OnHitEffect.SORD_DROP), new Item.Properties()));
	public static final DeferredItem<Item> HEMEOREAPER = REGISTER.register("hemeoreaper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.2F).efficiency(1.0F).set(SICKLE_TOOL), new Item.Properties().defaultDurability(550)));
	public static final DeferredItem<Item> THORNY_SUBJECT = REGISTER.register("thorny_subject", () -> new WeaponItem(new WeaponItem.Builder(CACTUS_TIER, 4, -2.2F).efficiency(1.0F).set(SICKLE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> SNOW_WHITE_DREAM = REGISTER.register("snow_white_dream", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 6, -2.2F).efficiency(2.0F).set(SICKLE_TOOL).add(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 140, 0))), new Item.Properties().defaultDurability(2048)));
	public static final DeferredItem<Item> HOMES_SMELL_YA_LATER = REGISTER.register("homes_smell_ya_later", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.2F).efficiency(3.0F).set(SICKLE_TOOL), new Item.Properties().defaultDurability(400)));
	public static final DeferredItem<Item> FUDGESICKLE = REGISTER.register("fudgesickle", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 5, -2.2F).efficiency(1.0F).set(SICKLE_TOOL).setEating(FinishUseItemEffect.foodEffect(7, 0.6F)), new Item.Properties()));
	public static final DeferredItem<Item> REGISICKLE = REGISTER.register("regisickle", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 4, -2.2F).efficiency(4.0F).set(SICKLE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> HERETICUS_AURURM = REGISTER.register("hereticus_aururm", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 9, -2.2F).efficiency(4.0F).set(SICKLE_TOOL), new Item.Properties().defaultDurability(1024)));
	public static final DeferredItem<Item> CLAW_SICKLE = REGISTER.register("claw_sickle", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 8, -2.2F).efficiency(4.0F).set(SICKLE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CLAW_OF_NRUBYIGLITH = REGISTER.register("claw_of_nrubyiglith", () -> new WeaponItem(new WeaponItem.Builder(HORRORTERROR_TIER, 6, -2.2F).efficiency(4.0F).set(SICKLE_TOOL).add(OnHitEffect.HORRORTERROR), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CANDY_SICKLE = REGISTER.register("candy_sickle", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 6, -2.2F).efficiency(2.5F).set(SICKLE_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	
	
	//Scythes
	public static final DeferredItem<Item> SCYTHE = REGISTER.register("scythe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.6F).efficiency(1.5F).set(SICKLE_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> MARASCHINO_CHERRY_SCYTHE = REGISTER.register("maraschino_cherry_scythe", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 6, -2.6F).efficiency(1.5F).set(SICKLE_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> KISSY_CUTIE_HEART_SPLITTER = REGISTER.register("kissy_cutie_heart_splitter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 4, -2.6F).efficiency(10.0F).set(SICKLE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.KISSY_CUTIE_HEART_HITTER)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> MUTANT_CUTIE_CELL_CUTTER = REGISTER.register("mutant_cutie_cell_cutter", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 4, -2.6F).efficiency(10.0F).set(SICKLE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.MUTANT_CUTIE_CELL_PUTTER)).add(OnHitEffect.playSound(() -> SoundEvents.CAT_PURREOW)), new Item.Properties().defaultDurability(2000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> PROSPECTING_PICKSCYTHE = REGISTER.register("prospecting_pickscythe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 7, -2.6F).set(PICKAXE_TOOL), new Item.Properties().defaultDurability(100)));
	public static final DeferredItem<Item> EIGHTBALL_SCYTHE = REGISTER.register("eightball_scythe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.6F).efficiency(1.5F).set(SICKLE_TOOL).add(OnHitEffect.RANDOM_DAMAGE).set(ItemRightClickEffect.EIGHTBALL), new Item.Properties().defaultDurability(600)));
	public static final DeferredItem<Item> TIME_FLAYER = REGISTER.register("time_flayer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.6F).efficiency(1.5F).set(SICKLE_TOOL).add(OnHitEffect.RANDOM_DAMAGE), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> DESTINY_DECIMATOR = REGISTER.register("destiny_decimator", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 4, -2.6F).efficiency(1.5F).set(SICKLE_TOOL), new Item.Properties().fireResistant()));
	public static final DeferredItem<Item> SUNRAY_HARVESTER = REGISTER.register("sunray_harvester", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 4, -2.6F).efficiency(1.5F).set(SICKLE_TOOL).add(OnHitEffect.setOnFire(35)), new Item.Properties().defaultDurability(1200)));
	public static final DeferredItem<Item> GREEN_SUN_RAYREAPER = REGISTER.register("green_sun_rayreaper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 7, -2.6F).efficiency(1.5F).set(SICKLE_TOOL).add(OnHitEffect.setOnFire(10)), new Item.Properties().fireResistant().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> SKAITHE = REGISTER.register("skaithe", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 8, -2.6F).efficiency(1.5F).set(SICKLE_TOOL), new Item.Properties().rarity(Rarity.UNCOMMON)));
	
	public static final DeferredItem<Item> HELLBRINGERS_HOE_INACTIVE = REGISTER.register("hellbringers_hoe_inactive", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 3, -2.4F).efficiency(10.0F).set(SICKLE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.HELLBRINGERS_HOE_ACTIVE)), new Item.Properties()));
	public static final DeferredItem<Item> HELLBRINGERS_HOE_ACTIVE = REGISTER.register("hellbringers_hoe_active", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 2, -2.4F).efficiency(10.0F).set(SICKLE_TOOL).set(ItemRightClickEffect.switchTo(MSItems.HELLBRINGERS_HOE_INACTIVE)).add(OnHitEffect.setOnFire(10)), new Item.Properties()));
	
	
	//Clubs
	public static final DeferredItem<Item> DEUCE_CLUB = REGISTER.register("deuce_club", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 3, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> STALE_BAGUETTE = REGISTER.register("stale_baguette", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.SPAWN_BREADCRUMBS).setEating(FinishUseItemEffect.SPAWN_BREADCRUMBS, FinishUseItemEffect.foodEffect(3, 0.2F)), new Item.Properties()));
	public static final DeferredItem<Item> GLUB_CLUB = REGISTER.register("glub_club", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 4, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.playSound(() -> SoundEvents.GUARDIAN_FLOP)), new Item.Properties()));
	public static final DeferredItem<Item> NIGHT_CLUB = REGISTER.register("night_club", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 1, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> NIGHTSTICK = REGISTER.register("nightstick", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 2, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2500)));
	public static final DeferredItem<Item> RED_EYES = REGISTER.register("red_eyes", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 140, 0))), new Item.Properties()));
	public static final DeferredItem<Item> PRISMARINE_BASHER = REGISTER.register("prismarine_basher", () -> new WeaponItem(new WeaponItem.Builder(PRISMARINE_TIER, 3, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CLUB_ZERO = REGISTER.register("club_zero", () -> new WeaponItem(new WeaponItem.Builder(ICE_TIER, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.ICE_SHARD), new Item.Properties()));
	public static final DeferredItem<Item> POGO_CLUB = REGISTER.register("pogo_club", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 4, -2.8F).efficiency(2.0F).set(MISC_TOOL).set(PogoEffect.EFFECT_05).add(PogoEffect.EFFECT_05), new Item.Properties()));
	public static final DeferredItem<Item> BARBER_BASHER = REGISTER.register("barber_basher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> METAL_BAT = REGISTER.register("metal_bat", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CRICKET_BAT = REGISTER.register("cricket_bat", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 7, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CLOWN_CLUB = REGISTER.register("clown_club", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.RAGE_STRENGTH, OnHitEffect.playSound(MSSoundEvents.ITEM_HORN_USE, 1.5F, 1)), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> DOCTOR_DETERRENT = REGISTER.register("doctor_deterrent", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 9, -2.8F).efficiency(2.0F).set(MISC_TOOL).setEating(64, FinishUseItemEffect.potionEffect(() -> new MobEffectInstance(MobEffects.HEAL, 1, 0), 1F), FinishUseItemEffect.foodEffect(1, 0.6F, 250)), new Item.Properties().defaultDurability(2048)));
	public static final DeferredItem<Item> MACE = REGISTER.register("mace", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> M_ACE = REGISTER.register("m_ace", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(750)));
	public static final DeferredItem<Item> M_ACE_OF_CLUBS = REGISTER.register("m_ace_of_clubs", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(750)));
	public static final DeferredItem<Item> DESOLATOR_MACE = REGISTER.register("desolator_mace", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.armorBypassingDamageMod(4, EnumAspect.VOID)), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> BLAZING_GLORY = REGISTER.register("blazing_glory", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.setOnFire(35)), new Item.Properties().defaultDurability(750)));
	public static final DeferredItem<Item> SPIKED_CLUB = REGISTER.register("spiked_club", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 5, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(100)));
	public static final DeferredItem<Item> RUBIKS_MACE = REGISTER.register("rubiks_mace", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> HOME_GROWN_MACE = REGISTER.register("home_grown_mace", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> CARNIE_CLUB = REGISTER.register("carnie_club", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.playSound(MSSoundEvents.ITEM_HORN_USE)), new Item.Properties().defaultDurability(3666).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> TOFFEE_CLUB = REGISTER.register("toffee_club", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 6, -2.8F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	
	public static final DeferredItem<Item> HORSE_HITCHER = REGISTER.register("horse_hitcher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ACE_OF_SPADES)), new Item.Properties().defaultDurability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_SPADES = REGISTER.register("ace_of_spades", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(ItemRightClickEffect.switchTo(MSItems.HORSE_HITCHER)), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> CLUB_OF_FELONY = REGISTER.register("club_of_felony", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ACE_OF_CLUBS)), new Item.Properties().defaultDurability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_CLUBS = REGISTER.register("ace_of_clubs", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(ItemRightClickEffect.switchTo(MSItems.CLUB_OF_FELONY)), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> CUESTICK = REGISTER.register("cuestick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.0F).efficiency(2.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ACE_OF_DIAMONDS)), new Item.Properties().defaultDurability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_DIAMONDS = REGISTER.register("ace_of_diamonds", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(ItemRightClickEffect.switchTo(MSItems.CUESTICK)), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> TV_ANTENNA = REGISTER.register("tv_antenna", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -1.4F).efficiency(2.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ACE_OF_HEARTS)), new Item.Properties().defaultDurability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_HEARTS = REGISTER.register("ace_of_hearts", () -> new WeaponItem(new WeaponItem.Builder(PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(ItemRightClickEffect.switchTo(MSItems.TV_ANTENNA)), new Item.Properties().defaultDurability(500)));
	
	//Staffs
	public static final DeferredItem<Item> BO_STAFF = REGISTER.register("bo_staff", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(ToolActions.SWORD_SWEEP).add(OnHitEffect.enemyKnockback(0.5F)), new Item.Properties().defaultDurability(100)));
	public static final DeferredItem<Item> BAMBOO_BEATSTICK = REGISTER.register("bamboo_beatstick", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(ToolActions.SWORD_SWEEP).add(OnHitEffect.enemyKnockback(0.5F)), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> TELESCOPIC_BEATDOWN_BRUISER = REGISTER.register("telescopic_beatdown_bruiser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.enemyKnockback(0.5F)), new Item.Properties().defaultDurability(550)));
	public static final DeferredItem<Item> ION_DESTABILIZER = REGISTER.register("ion_destabilizer", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 2, -2.0F).efficiency(4.0F).set(MULTI_TOOL).add(ToolActions.SWORD_SWEEP).add(OnHitEffect.enemyKnockback(0.5F)).add(OnHitEffect.setOnFire(4)).add(OnHitEffect.spawnParticles(ParticleTypes.ITEM_SLIME, 6, 2.0, 1.0, 2.0, 1.0)), new Item.Properties().defaultDurability(1400).rarity(Rarity.UNCOMMON)));
	
	public static final DeferredItem<Item> WIZARD_STAFF = REGISTER.register("wizard_staff", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 5, -2.8F).efficiency(4.0F).set(MISC_TOOL).set(MagicAOERightClickEffect.STANDARD_MAGIC), new Item.Properties().defaultDurability(1024)));
	public static final DeferredItem<Item> BARBERS_MAGIC_TOUCH = REGISTER.register("barbers_magic_touch", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.8F).efficiency(1.0F).set(MISC_TOOL).add(ToolActions.SWORD_SWEEP).add(OnHitEffect.enemyKnockback(0.5F)).set(MagicAOERightClickEffect.STANDARD_MAGIC), new Item.Properties().defaultDurability(660)));
	public static final DeferredItem<Item> WATER_STAFF = REGISTER.register("water_staff", () -> new WeaponItem(new WeaponItem.Builder(EMERALD_TIER, 5, -2.8F).efficiency(4.0F).set(MISC_TOOL).set(MagicAOERightClickEffect.WATER_MAGIC), new Item.Properties().defaultDurability(1250)));
	public static final DeferredItem<Item> FIRE_STAFF = REGISTER.register("fire_staff", () -> new WeaponItem(new WeaponItem.Builder(EMERALD_TIER, 5, -2.8F).efficiency(4.0F).set(MISC_TOOL).set(MagicAOERightClickEffect.FIRE_MAGIC), new Item.Properties().defaultDurability(1250)));
	public static final DeferredItem<Item> WHITE_KINGS_SCEPTER = REGISTER.register("white_kings_scepter", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 8, -2.8F).efficiency(4.0F).set(MISC_TOOL).set(ItemRightClickEffect.summonFireball()), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> BLACK_KINGS_SCEPTER = REGISTER.register("black_kings_scepter", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 8, -2.8F).efficiency(4.0F).set(MISC_TOOL).set(ItemRightClickEffect.summonFireball()), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> PRIME_STAFF = REGISTER.register("prime_staff", () -> new WeaponItem(new WeaponItem.Builder(WELSH_TIER, 8, -2.8F).efficiency(4.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.ZILLY_MAGIC), new Item.Properties().fireResistant().rarity(Rarity.RARE)));
	
	
	//Canes
	public static final DeferredItem<Item> CANE = REGISTER.register("cane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(100)));
	public static final DeferredItem<Item> VAUDEVILLE_HOOK = REGISTER.register("vaudeville_hook", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(150)));
	public static final DeferredItem<Item> BEAR_POKING_STICK = REGISTER.register("bear_poking_stick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.notAtPlayer(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 140, 1)))), new Item.Properties().defaultDurability(150)));
	public static final DeferredItem<Item> CROWBAR = REGISTER.register("crowbar", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.playSound(() -> SoundEvents.ANVIL_PLACE)), new Item.Properties().defaultDurability(-1).rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> UMBRELLA = REGISTER.register("umbrella", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(InventoryTickEffect.BREATH_SLOW_FALLING), new Item.Properties().defaultDurability(350)));
	public static final DeferredItem<Item> BARBERS_BEST_FRIEND = REGISTER.register("barbers_best_friend", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> UPPER_CRUST_CRUST_CANE = REGISTER.register("upper_crust_crust_cane", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.0F).efficiency(2.0F).set(MISC_TOOL).add(OnHitEffect.SPAWN_BREADCRUMBS).setEating(FinishUseItemEffect.SPAWN_BREADCRUMBS, FinishUseItemEffect.foodEffect(4, 0.5F)), new Item.Properties()));
	public static final DeferredItem<Item> IRON_CANE = REGISTER.register("iron_cane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> KISSY_CUTIE_HEART_HITTER = REGISTER.register("kissy_cutie_heart_hitter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.KISSY_CUTIE_HEART_SPLITTER)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> MUTANT_CUTIE_CELL_PUTTER = REGISTER.register("mutant_cutie_cell_putter", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.MUTANT_CUTIE_CELL_CUTTER)).add(OnHitEffect.playSound(() -> SoundEvents.CAT_PURREOW)), new Item.Properties().defaultDurability(2000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ZEPHYR_CANE = REGISTER.register("zephyr_cane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(PropelEffect.BREATH_PROPEL), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> SPEAR_CANE = REGISTER.register("spear_cane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> PARADISES_PORTABELLO = REGISTER.register("paradises_portabello", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> REGI_CANE = REGISTER.register("regi_cane", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 4, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> POGO_CANE = REGISTER.register("pogo_cane", () -> new WeaponItem(new WeaponItem.Builder(POGO_TIER, 2, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(PogoEffect.EFFECT_06).add(PogoEffect.EFFECT_06), new Item.Properties()));
	public static final DeferredItem<Item> CANDY_CANE = REGISTER.register("candy_cane", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG).setEating(FinishUseItemEffect.foodEffect(2, 0.3F), FinishUseItemEffect.SHARPEN_CANDY_CANE), new Item.Properties()));
	public static final DeferredItem<Item> SHARP_CANDY_CANE = REGISTER.register("sharp_candy_cane", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 5, -2.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> PRIM_AND_PROPER_WALKING_POLE = REGISTER.register("prim_and_proper_walking_pole", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> DRAGON_CANE = REGISTER.register("dragon_cane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 7, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.DRAGON_CANE_UNSHEATHED)), new Item.Properties().defaultDurability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> DRAGON_CANE_UNSHEATHED = REGISTER.register("dragon_cane_unsheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.DRAGON_CANE)), new Item.Properties().defaultDurability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT = REGISTER.register("chancewyrms_extra_fortunate_stabbing_implement", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 6, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT_UNSHEATHED)), new Item.Properties().defaultDurability(4096).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT_UNSHEATHED = REGISTER.register("chancewyrms_extra_fortunate_stabbing_implement_unsheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT)).add(OnHitEffect.RANDOM_DAMAGE), new Item.Properties().defaultDurability(4096).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> LESS_PROPER_WALKING_STICK = REGISTER.register("less_proper_walking_stick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.LESS_PROPER_WALKING_STICK_SHEATHED)), new Item.Properties().defaultDurability(600)));
	...
	public static final DeferredItem<Item> ROCKEFELLERS_WALKING_BLADECANE = REGISTER.register("rockefellers_walking_bladecane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.0F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.ROCKEFELLERS_WALKING_BLADECANE_SHEATHED)), new Item.Properties().defaultDurability(800).rarity(Rarity.UNCOMMON)));
	...
	//Spoons/Forks
	public static final DeferredItem<Item> WOODEN_SPOON = REGISTER.register("wooden_spoon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 2, -2.4F).efficiency(1.0F).set(SHOVEL_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> SILVER_SPOON = REGISTER.register("silver_spoon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -2.4F).efficiency(1.0F).set(SHOVEL_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> MELONBALLER = REGISTER.register("melonballer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.4F).efficiency(1.0F).set(SHOVEL_TOOL).set(RightClickBlockEffect.scoopBlock(() -> Blocks.MELON)), new Item.Properties().defaultDurability(500)));
	public static final DeferredItem<Item> SIGHTSEEKER = REGISTER.register("sightseeker", () -> new WeaponItem(new WeaponItem.Builder(ORGANIC_TIER, 6, -2.4F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> TERRAIN_FLATENATOR = REGISTER.register("terrain_flatenator", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(10.0F).set(SHOVEL_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 50)), new Item.Properties().defaultDurability(1024))); //TODO fix inability to use for terrain flattenation
	public static final DeferredItem<Item> NOSFERATU_SPOON = REGISTER.register("nosferatu_spoon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.4F).efficiency(1.0F).set(SHOVEL_TOOL).add(OnHitEffect.LIFE_SATURATION), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> THRONGLER = REGISTER.register("throngler", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.4F).efficiency(1.0F).set(SHOVEL_TOOL), new Item.Properties().defaultDurability(3200).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> WET_MEAT_SHIT_THRONGLER = REGISTER.register("wet_meat_shit_throngler", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 10, -2.9F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(3500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CROCKER_SPOON = REGISTER.register("crocker_spoon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.4F).efficiency(1.0F).set(SHOVEL_TOOL).set(ItemRightClickEffect.switchTo(MSItems.CROCKER_FORK)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CROCKER_FORK = REGISTER.register("crocker_fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.6F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.CROCKER_SPOON)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> EDISONS_FURY = REGISTER.register("edisons_fury", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.6F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.EDISONS_SERENITY)).add(OnHitEffect.DROP_FOE_ITEM).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties()));
	public static final DeferredItem<Item> EDISONS_SERENITY = REGISTER.register("edisons_serenity", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.6F).efficiency(1.0F).set(MISC_TOOL).set(ItemRightClickEffect.switchTo(MSItems.EDISONS_FURY)), new Item.Properties()));
	public static final DeferredItem<Item> SKAIA_FORK = REGISTER.register("skaia_fork", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 9, -2.6F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> SKAIAN_CROCKER_ROCKER = REGISTER.register("skaian_crocker_rocker", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, 10, -2.6F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties().defaultDurability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> FORK = REGISTER.register("fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 3, -2.6F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> CANDY_FORK = REGISTER.register("candy_fork", () -> new WeaponItem(new WeaponItem.Builder(CANDY_TIER, 5, -2.6F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties()));
	public static final DeferredItem<Item> TUNING_FORK = REGISTER.register("tuning_fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.6F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.playSound(SoundEvents.NOTE_BLOCK_CHIME::value)), new Item.Properties()));
	public static final DeferredItem<Item> ELECTRIC_FORK = REGISTER.register("electric_fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -2.6F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.DROP_FOE_ITEM).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties()));
	public static final DeferredItem<Item> EATING_FORK_GEM = REGISTER.register("eating_fork_gem", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.6F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> DEVIL_FORK = REGISTER.register("devil_fork", () -> new WeaponItem(new WeaponItem.Builder(URANIUM_TIER, 6, -2.6F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.setOnFire(35)), new Item.Properties()));
	
	public static final DeferredItem<Item> SPORK = REGISTER.register("spork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 4, -2.5F).efficiency(1.0F).set(SHOVEL_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> GOLDEN_SPORK = REGISTER.register("golden_spork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 5, -2.5F).efficiency(1.0F).set(SHOVEL_TOOL), new Item.Properties()));
	
	public static final DeferredItem<Item> MEATFORK = REGISTER.register("meatfork", () -> new WeaponItem(new WeaponItem.Builder(MEAT_TIER, 7, -2.9F).efficiency(1.0F).set(MISC_TOOL).setEating(FinishUseItemEffect.foodEffect(3, 0.8F, 75)), new Item.Properties()));
	public static final DeferredItem<Item> BIDENT = REGISTER.register("bident", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.9F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> DOUBLE_ENDED_TRIDENT = REGISTER.register("double_ended_trident", () -> new WeaponItem(new WeaponItem.Builder(PRISMARINE_TIER, 6, -2.9F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	
	
	//Needles/Wands
	public static final DeferredItem<Item> POINTY_STICK = REGISTER.register("pointy_stick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	public static final DeferredItem<Item> KNITTING_NEEDLE = REGISTER.register("knitting_needle", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -1, -1.0F).efficiency(1.0F).set(MISC_TOOL), new Item.Properties()));
	
	public static final DeferredItem<Item> WAND = REGISTER.register("wand", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -2, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC), new Item.Properties()));
	public static final DeferredItem<Item> NEEDLE_WAND = REGISTER.register("needle_wand", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC), new Item.Properties().defaultDurability(1024)));
	public static final DeferredItem<Item> ARTIFUCKER = REGISTER.register("artifucker", () -> new WeaponItem(new WeaponItem.Builder(SBAHJ_TIER, 1, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.SBAHJ_AIMBOT_MAGIC), new Item.Properties()));
	public static final DeferredItem<Item> POINTER_WAND = REGISTER.register("pointer_wand", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -1, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.AIMBOT_MAGIC), new Item.Properties().defaultDurability(512)));
	public static final DeferredItem<Item> POOL_CUE_WAND = REGISTER.register("pool_cue_wand", () -> new WeaponItem(new WeaponItem.Builder(REGI_TIER, -1, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.POOL_CUE_MAGIC), new Item.Properties().defaultDurability(1250)));
	public static final DeferredItem<Item> THORN_OF_OGLOGOTH = REGISTER.register("thorn_of_oglogoth", () -> new WeaponItem(new WeaponItem.Builder(HORRORTERROR_TIER, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL).add(OnHitEffect.HORRORTERROR).set(MagicRangedRightClickEffect.HORRORTERROR_MAGIC), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> THISTLE_OF_ZILLYWICH = REGISTER.register("thistle_of_zillywich", () -> new WeaponItem(new WeaponItem.Builder(ZILLY_TIER, 0, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.ZILLY_MAGIC), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> QUILL_OF_ECHIDNA = REGISTER.register("quill_of_echidna", () -> new WeaponItem(new WeaponItem.Builder(DENIZEN_TIER, -1, -1.0F).efficiency(1.0F).set(MISC_TOOL).set(MagicRangedRightClickEffect.ECHIDNA_MAGIC), new Item.Properties().rarity(Rarity.EPIC)));
	...
	public static final DeferredItem<Item> MINE_AND_GRIST = REGISTER.register("mine_and_grist", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -2.8F).efficiency(10.0F).set(PICKAXE_TOOL).add(MSItemTypes.GRIST_HARVEST), new Item.Properties()));
