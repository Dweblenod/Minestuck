...
public class MSItems
{
	...
	public static final RegistryObject<Item> POGO_HAMMER = REGISTER.register("pogo_hammer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 5, -3.2F).efficiency(2.0F).set(MSItemTypes.HAMMER_TOOL).pogo(0.7), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> WRINKLEFUCKER = REGISTER.register("wrinklefucker", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 7, -3.2F).efficiency(2.0F).set(MSItemTypes.HAMMER_TOOL).pogo(0.4), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> MELT_MASHER = REGISTER.register("melt_masher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 8, -3.2F).efficiency(12.0F).set(MSItemTypes.HAMMER_TOOL).fireAspect(25), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ESTROGEN_EMPOWERED_EVERYTHING_ERADICATOR = REGISTER.register("estrogen_empowered_everything_eradicator", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -3.2F).efficiency(9.0F).set(MSItemTypes.MULTI_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 200)).pogo(0.7), new Item.Properties().defaultDurability(6114).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> EEEEEEEEEEEE = REGISTER.register("eeeeeeeeeeee", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.SBAHJ_TIER, 9, -3.2F).efficiency(9.1F).set(MSItemTypes.HAMMER_TOOL).pogo(0.2).add(OnHitEffect.playSound(MSSoundEvents.ITEM_EEEEEEEEEEEE_HIT, 1.5F, 1.0F)), new Item.Properties().defaultDurability(6114).tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> SCARLET_ZILLYHOO = REGISTER.register("scarlet_zillyhoo", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 9, -3.2F).efficiency(4.0F).set(MSItemTypes.HAMMER_TOOL).fireAspect(50), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> WET_PUMORD = REGISTER.register("wet_pumord", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 3, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(OnHitEffect.SWEEP).set(RightClickBlockEffect.placeFluid(() -> Blocks.LAVA, MSItems.PUMORD)).add(OnHitEffect.playSound(() -> SoundEvents.BUCKET_EMPTY_LAVA, 1.0F, 0.2F)).fireAspect(10), new Item.Properties()));
	...
	public static final RegistryObject<Item> FIRE_POKER = REGISTER.register("fire_poker", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SWEEP).fireAspect(30), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> TOO_HOT_TO_HANDLE = REGISTER.register("too_hot_to_handle", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SWEEP).fireAspect(10), new Item.Properties().defaultDurability(350).tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> COBALT_SABRE = REGISTER.register("cobalt_sabre", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 7, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(OnHitEffect.SWEEP).fireAspect(30), new Item.Properties().defaultDurability(300).tab(MSItemGroup.WEAPONS)));
	...
	//Knives
	public static final RegistryObject<Item> DAGGER = REGISTER.register("dagger", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(3), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> DIAMOND_DAGGER = REGISTER.register("diamond_dagger", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> PIGLINS_PRIDE = REGISTER.register("piglins_pride", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4).add(OnHitEffect.targetSpecificAdditionalDamage(4, () -> EntityType.PIGLIN)), new Item.Properties().tab(MSItemGroup.WEAPONS).fireResistant()));
	public static final RegistryObject<Item> BASILISK_BREATH_DRAGONSLAYER = REGISTER.register("basilisk_breath_dragonslayer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4).add(OnHitEffect.targetSpecificAdditionalDamage(6, MSEntityTypes.BASILISK)), new Item.Properties().tab(MSItemGroup.WEAPONS).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> HALLOWED_SKEWER = REGISTER.register("hallowed_skewer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(9), new Item.Properties().tab(MSItemGroup.WEAPONS).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> GENESIS_GODSTABBER = REGISTER.register("genesis_godstabber", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.WELSH_TIER, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(9), new Item.Properties().defaultDurability(1561).tab(MSItemGroup.WEAPONS).fireResistant().rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> LIGHT_OF_MY_KNIFE = REGISTER.register("light_of_my_knife", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.EMERALD_TIER, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4).fireAspect(35), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> THOUSAND_DEGREE_KNIFE = REGISTER.register("thousand_degree_knife", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4).fireAspect(35), new Item.Properties().tab(MSItemGroup.WEAPONS).fireResistant()));
	public static final RegistryObject<Item> STARSHARD_TRI_BLADE = REGISTER.register("starshard_tri_blade", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(9), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> TOOTHRIPPER = REGISTER.register("toothripper", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4), new Item.Properties().defaultDurability(1200).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SHADOWRAZOR = REGISTER.register("shadowrazor", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).backstab(4).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(1500).tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> HOME_BY_MIDNIGHT = REGISTER.register("home_by_midnight", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).pogo(0.7), new Item.Properties().defaultDurability(4000).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<Item> SHOCK_AXE = REGISTER.register("shock_axe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(6.0F).disableShield().set(MSItemTypes.AXE_TOOL).switchTo(MSItems.SHOCK_AXE_UNPOWERED).add(OnHitEffect.DROP_FOE_ITEM).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties().defaultDurability(800).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SHOCK_AXE_UNPOWERED = REGISTER.register("shock_axe_unpowered", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(6.0F).disableShield().set(MSItemTypes.AXE_TOOL).switchTo(MSItems.SHOCK_AXE), new Item.Properties().defaultDurability(800)));
	...
	//Claws
	public static final RegistryObject<Item> MAKESHIFT_CLAWS_DRAWN = REGISTER.register("makeshift_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 1, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.MAKESHIFT_CLAWS_SHEATHED), new Item.Properties().defaultDurability(200).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> MAKESHIFT_CLAWS_SHEATHED = REGISTER.register("makeshift_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, -1, -1.0F).efficiency(10.0F).switchTo(MSItems.MAKESHIFT_CLAWS_DRAWN), new Item.Properties().defaultDurability(200)));
	public static final RegistryObject<Item> CAT_CLAWS_DRAWN = REGISTER.register("cat_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.CAT_CLAWS_SHEATHED), new Item.Properties().defaultDurability(500).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> CAT_CLAWS_SHEATHED = REGISTER.register("cat_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -1, -1.0F).efficiency(10.0F).switchTo(MSItems.CAT_CLAWS_DRAWN), new Item.Properties().defaultDurability(500)));
	public static final RegistryObject<Item> POGO_CLAWS = REGISTER.register("pogo_claws", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 2, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).pogo(0.7), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> ATOMIKITTY_KATAR_DRAWN = REGISTER.register("atomikitty_katar_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 1, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.ATOMIKITTY_KATAR_SHEATHED).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1)))), new Item.Properties().defaultDurability(600).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> ATOMIKITTY_KATAR_SHEATHED = REGISTER.register("atomikitty_katar_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, -1, -1.0F).efficiency(10.0F).switchTo(MSItems.ATOMIKITTY_KATAR_DRAWN), new Item.Properties().defaultDurability(600)));
	public static final RegistryObject<Item> SKELETONIZER_DRAWN = REGISTER.register("skeletonizer_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.SKELETONIZER_SHEATHED), new Item.Properties().defaultDurability(750).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SKELETONIZER_SHEATHED = REGISTER.register("skeletonizer_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, -1, -1.0F).efficiency(10.0F).switchTo(MSItems.SKELETONIZER_DRAWN), new Item.Properties().defaultDurability(750)));
	public static final RegistryObject<Item> SKELETON_DISPLACER_DRAWN = REGISTER.register("skeleton_displacer_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 6, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.SKELETON_DISPLACER_SHEATHED).add(OnHitEffect.targetSpecificAdditionalDamage(4, () -> EntityType.SKELETON)), new Item.Properties().defaultDurability(1250).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SKELETON_DISPLACER_SHEATHED = REGISTER.register("skeleton_displacer_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, -1, -1.0F).efficiency(10.0F).switchTo(MSItems.SKELETON_DISPLACER_DRAWN), new Item.Properties().defaultDurability(1250)));
	public static final RegistryObject<Item> TEARS_OF_THE_ENDERLICH_DRAWN = REGISTER.register("tears_of_the_enderlich_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.TEARS_OF_THE_ENDERLICH_SHEATHED).add(OnHitEffect.targetSpecificAdditionalDamage(6, MSEntityTypes.LICH)), new Item.Properties().defaultDurability(2000).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> TEARS_OF_THE_ENDERLICH_SHEATHED = REGISTER.register("tears_of_the_enderlich_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, -4, -1.0F).efficiency(10.0F).switchTo(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN), new Item.Properties().defaultDurability(2000).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> LION_LACERATORS_DRAWN = REGISTER.register("lion_lacerators_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.LION_LACERATORS_SHEATHED).add(OnHitEffect.targetSpecificAdditionalDamage(4, MSEntityTypes.LICH)), new Item.Properties().defaultDurability(2031).tab(MSItemGroup.WEAPONS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> LION_LACERATORS_SHEATHED = REGISTER.register("lion_lacerators_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, -4, -1.0F).efficiency(10.0F).switchTo(MSItems.LION_LACERATORS_DRAWN), new Item.Properties().defaultDurability(2031).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> ACTION_CLAWS_DRAWN = REGISTER.register("action_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).switchTo(MSItems.ACTION_CLAWS_SHEATHED), new Item.Properties().defaultDurability(4096).tab(MSItemGroup.WEAPONS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> ACTION_CLAWS_SHEATHED = REGISTER.register("action_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, -1, -1.0F).efficiency(10.0F).switchTo(MSItems.ACTION_CLAWS_DRAWN), new Item.Properties().defaultDurability(4096).rarity(Rarity.RARE)));
	
	
	//Chainsaws
	public static final RegistryObject<Item> LIPSTICK_CHAINSAW = REGISTER.register("lipstick_chainsaw", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.LIPSTICK), new Item.Properties().defaultDurability(250).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> LIPSTICK = REGISTER.register("lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.LIPSTICK_CHAINSAW), new Item.Properties().defaultDurability(250)));
	public static final RegistryObject<Item> CAKESAW = REGISTER.register("cakesaw", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.CAKESAW_LIPSTICK).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> CAKESAW_LIPSTICK = REGISTER.register("cakesaw_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(CAKESAW), new Item.Properties().defaultDurability(450)));
	public static final RegistryObject<Item> MAGENTA_MAULER = REGISTER.register("magenta_mauler", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.MAGENTA_MAULER_LIPSTICK), new Item.Properties().defaultDurability(500).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> MAGENTA_MAULER_LIPSTICK = REGISTER.register("magenta_mauler_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.MAGENTA_MAULER), new Item.Properties().defaultDurability(500)));
	public static final RegistryObject<Item> THISTLEBLOWER = REGISTER.register("thistleblower", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -1.0F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.THISTLEBLOWER_LIPSTICK), new Item.Properties().defaultDurability(500).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> THISTLEBLOWER_LIPSTICK = REGISTER.register("thistleblower_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.THISTLEBLOWER), new Item.Properties().defaultDurability(500)));
	public static final RegistryObject<Item> EMERALD_IMMOLATOR = REGISTER.register("emerald_immolator", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.EMERALD_TIER, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.EMERALD_IMMOLATOR_LIPSTICK).fireAspect(5), new Item.Properties().defaultDurability(1024).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> EMERALD_IMMOLATOR_LIPSTICK = REGISTER.register("emerald_immolator_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.EMERALD_IMMOLATOR), new Item.Properties().defaultDurability(1024)));
	public static final RegistryObject<Item> OBSIDIATOR = REGISTER.register("obsidiator", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.OBSIDIATOR_LIPSTICK), new Item.Properties().defaultDurability(2048).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> OBSIDIATOR_LIPSTICK = REGISTER.register("obsidiator_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.OBSIDIATOR), new Item.Properties().defaultDurability(2048).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> DEVILS_DELIGHT = REGISTER.register("devils_delight", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.DEVILS_DELIGHT_LIPSTICK).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(1536).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> DEVILS_DELIGHT_LIPSTICK = REGISTER.register("devils_delight_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.DEVILS_DELIGHT), new Item.Properties().defaultDurability(1536).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> DEMONBANE_RAGRIPPER = REGISTER.register("demonbane_ragripper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.DEMONBANE_RAGRIPPER_LIPSTICK).add(OnHitEffect.onCrit(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties().defaultDurability(2048).tab(MSItemGroup.WEAPONS).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> DEMONBANE_RAGRIPPER_LIPSTICK = REGISTER.register("demonbane_ragripper_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.DEMONBANE_RAGRIPPER), new Item.Properties().defaultDurability(2048).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> FROSTTOOTH = REGISTER.register("frosttooth", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ICE_TIER, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.AXE_TOOL).switchTo(MSItems.FROSTTOOTH_LIPSTICK).add(OnHitEffect.ICE_SHARD), new Item.Properties().defaultDurability(1536).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> FROSTTOOTH_LIPSTICK = REGISTER.register("frosttooth_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).switchTo(MSItems.FROSTTOOTH), new Item.Properties().defaultDurability(1536)));
	...
	public static final RegistryObject<Item> SKY_PIERCER = REGISTER.register("sky_piercer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 5, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).fireAspect(30), new Item.Properties().tab(MSItemGroup.WEAPONS).fireResistant()));
	...
	//Fans
	public static final RegistryObject<Item> FAN = REGISTER.register("fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(1.5F), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> CANDY_FAN = REGISTER.register("candy_fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(1.5F).add(OnHitEffect.SET_CANDY_DROP_FLAG), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SPINES_OF_FLUTHLU = REGISTER.register("spines_of_fluthlu", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(1.5F).add(OnHitEffect.HORRORTERROR), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> RAZOR_FAN = REGISTER.register("razor_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(1.5F), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> MOTOR_FAN = REGISTER.register("motor_fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(2.0F), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> ATOMIC_VAPORIZER = REGISTER.register("atomic_vaporizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(2.0F).add(OnHitEffect.enemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1))), new Item.Properties().defaultDurability(2048).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> SHAVING_FAN = REGISTER.register("shaving_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(1.5F), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> FIRESTARTER = REGISTER.register("firestarter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).knockback(1.5F).fireAspect(35), new Item.Properties().durability(300).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> STAR_RAY = REGISTER.register("star_ray", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(1)).knockback(1.5F).fireAspect(35), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> TYPHONIC_TRIVIALIZER = REGISTER.register("typhonic_trivializer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 2, -1.0F).efficiency(1.5F).set(MSItemTypes.MISC_TOOL).set(ItemRightClickEffect.extinguishFire(3)).add(OnHitEffect.BREATH_LEVITATION_AOE).knockback(2.0F), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> SUNRAY_HARVESTER = REGISTER.register("sunray_harvester", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 4, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SICKLE_TOOL).fireAspect(35), new Item.Properties().defaultDurability(1200).tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> GREEN_SUN_RAYREAPER = REGISTER.register("green_sun_rayreaper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 7, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SICKLE_TOOL).fireAspect(10), new Item.Properties().tab(MSItemGroup.WEAPONS).fireResistant().rarity(Rarity.RARE)));
	...
	public static final RegistryObject<Item> HELLBRINGERS_HOE_INACTIVE = REGISTER.register("hellbringers_hoe_inactive", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 3, -2.4F).efficiency(10.0F).set(MSItemTypes.SICKLE_TOOL).switchTo(MSItems.HELLBRINGERS_HOE_ACTIVE), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> HELLBRINGERS_HOE_ACTIVE = REGISTER.register("hellbringers_hoe_active", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 2, -2.4F).efficiency(10.0F).set(MSItemTypes.SICKLE_TOOL).switchTo(MSItems.HELLBRINGERS_HOE_INACTIVE).fireAspect(10), new Item.Properties()));
	...
	public static final RegistryObject<Item> POGO_CLUB = REGISTER.register("pogo_club", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 4, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).pogo(0.5), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> BLAZING_GLORY = REGISTER.register("blazing_glory", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).fireAspect(35), new Item.Properties().defaultDurability(750).tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> HORSE_HITCHER = REGISTER.register("horse_hitcher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).switchTo(MSItems.ACE_OF_SPADES), new Item.Properties().defaultDurability(500).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ACE_OF_SPADES = REGISTER.register("ace_of_spades", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).switchTo(MSItems.HORSE_HITCHER), new Item.Properties().defaultDurability(500)));
	public static final RegistryObject<Item> CLUB_OF_FELONY = REGISTER.register("club_of_felony", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).switchTo(MSItems.ACE_OF_CLUBS), new Item.Properties().defaultDurability(500).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ACE_OF_CLUBS = REGISTER.register("ace_of_clubs", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).switchTo(MSItems.CLUB_OF_FELONY), new Item.Properties().defaultDurability(500)));
	public static final RegistryObject<Item> CUESTICK = REGISTER.register("cuestick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.0F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).switchTo(MSItems.ACE_OF_DIAMONDS), new Item.Properties().defaultDurability(500).tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> ACE_OF_DIAMONDS = REGISTER.register("ace_of_diamonds", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).switchTo(MSItems.CUESTICK), new Item.Properties().defaultDurability(500)));
	...
	public static final RegistryObject<Item> POGO_CANE = REGISTER.register("pogo_cane", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 2, -2.0F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).pogo(0.6), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	...
	public static final RegistryObject<Item> CROCKER_SPOON = REGISTER.register("crocker_spoon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.4F).efficiency(1.0F).set(MSItemTypes.SHOVEL_TOOL).switchTo(MSItems.CROCKER_FORK), new Item.Properties().tab(MSItemGroup.WEAPONS).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> CROCKER_FORK = REGISTER.register("crocker_fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).switchTo(MSItems.CROCKER_SPOON), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> EDISONS_FURY = REGISTER.register("edisons_fury", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).switchTo(MSItems.EDISONS_SERENITY).add(OnHitEffect.DROP_FOE_ITEM).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties().tab(MSItemGroup.WEAPONS)));
	public static final RegistryObject<Item> EDISONS_SERENITY = REGISTER.register("edisons_serenity", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).switchTo(MSItems.EDISONS_FURY), new Item.Properties()));
	...
	public static final RegistryObject<Item> DEVIL_FORK = REGISTER.register("devil_fork", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 6, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).fireAspect(35), new Item.Properties().tab(MSItemGroup.WEAPONS)));
