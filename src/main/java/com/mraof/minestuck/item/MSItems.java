...
public class MSItems
{
	...
	public static final DeferredItem<Item> FEAR_NO_ANVIL = REGISTER.register("fear_no_anvil", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 7, -3.2F).efficiency(7.0F).set(MSItemTypes.HAMMER_TOOL).add(OnHitEffect.TIME_SLOWNESS_AOE).add(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1))), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> MELT_MASHER = REGISTER.register("melt_masher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 8, -3.2F).efficiency(12.0F).set(MSItemTypes.HAMMER_TOOL).add(new OnHitEffect.SetOnFire(25)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> POPAMATIC_VRILLYHOO = REGISTER.register("popamatic_vrillyhoo", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ZILLY_TIER, 6, -3.2F).efficiency(15.0F).set(MSItemTypes.HAMMER_TOOL).add(new OnHitEffect.RandomDamage()), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> SCARLET_ZILLYHOO = REGISTER.register("scarlet_zillyhoo", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 9, -3.2F).efficiency(4.0F).set(MSItemTypes.HAMMER_TOOL).add(new OnHitEffect.SetOnFire(50)), new Item.Properties().rarity(Rarity.RARE)));
	...
	//Blades
	public static final DeferredItem<Item> SORD = REGISTER.register("sord", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.SBAHJ_TIER, 3, -3.0F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.SordDrop()), new Item.Properties()));
	public static final DeferredItem<Item> PAPER_SWORD = REGISTER.register("paper_sword", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 2, -2.4F).efficiency(3.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties()));
	public static final DeferredItem<Item> SWONGE = REGISTER.register("swonge", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(new OnHitEffect.Sweep()).set(new ItemRightClickEffect.AbsorbFluid(() -> Blocks.WATER, MSItems.WET_SWONGE)), new Item.Properties()));
	public static final DeferredItem<Item> WET_SWONGE = REGISTER.register("wet_swonge", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(new OnHitEffect.Sweep()).set(new RightClickBlockEffect.PlaceFluid(() -> Blocks.WATER, MSItems.SWONGE)).add(OnHitEffect.playSound(() -> SoundEvents.GUARDIAN_FLOP)), new Item.Properties()));
	public static final DeferredItem<Item> PUMORD = REGISTER.register("pumord", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(new OnHitEffect.Sweep()).set(new ItemRightClickEffect.AbsorbFluid(() -> Blocks.LAVA, MSItems.WET_PUMORD)), new Item.Properties()));
	public static final DeferredItem<Item> WET_PUMORD = REGISTER.register("wet_pumord", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 3, -2.6F).efficiency(1.0F).set(MSItemTypes.MISC_TOOL).add(new OnHitEffect.Sweep()).set(new RightClickBlockEffect.PlaceFluid(() -> Blocks.LAVA, MSItems.PUMORD)).add(OnHitEffect.playSound(() -> SoundEvents.BUCKET_EMPTY_LAVA, 1.0F, 0.2F)).add(new OnHitEffect.SetOnFire(10)), new Item.Properties()));
	public static final DeferredItem<Item> CACTACEAE_CUTLASS = REGISTER.register("cactaceae_cutlass", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CACTUS_TIER, 3, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties())); //The sword harvestTool is only used against webs, hence the high efficiency.
	public static final DeferredItem<Item> STEAK_SWORD = REGISTER.register("steak_sword", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.MEAT_TIER, 4, -2.4F).efficiency(5.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).setEating(FinishUseItemEffect.foodEffect(8, 1F)), new MSItemProperties().durability(250)));
	public static final DeferredItem<Item> BEEF_SWORD = REGISTER.register("beef_sword", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.MEAT_TIER, 2, -2.4F).efficiency(5.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).setEating(FinishUseItemEffect.foodEffect(3, 0.8F, 75)), new Item.Properties()));
	public static final DeferredItem<Item> IRRADIATED_STEAK_SWORD = REGISTER.register("irradiated_steak_sword", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.MEAT_TIER, 5, -2.4F).efficiency(5.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).setEating(FinishUseItemEffect.potionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1), 0.9F), FinishUseItemEffect.foodEffect(4, 0.4F, 25)), new MSItemProperties().durability(300)));
	public static final DeferredItem<Item> MACUAHUITL = REGISTER.register("macuahuitl", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PRISMARINE_TIER, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new MSItemProperties().durability(100)));
	public static final DeferredItem<Item> FROSTY_MACUAHUITL = REGISTER.register("frosty_macuahuitl", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ICE_TIER, 6, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.IceShard()), new MSItemProperties().durability(200)));
	public static final DeferredItem<Item> KATANA = REGISTER.register("katana", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties()));
	public static final DeferredItem<Item> UNBREAKABLE_KATANA = REGISTER.register("unbreakable_katana", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ZILLY_TIER, 6, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().component(DataComponents.UNBREAKABLE, new Unbreakable(false)).rarity(Rarity.RARE))); //Actually unbreakable
	public static final DeferredItem<Item> ANGEL_APOCALYPSE = REGISTER.register("angel_apocalypse", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(OnHitEffect.HOPE_RESISTANCE), new MSItemProperties().durability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> FIRE_POKER = REGISTER.register("fire_poker", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetOnFire(30)), new Item.Properties()));
	public static final DeferredItem<Item> TOO_HOT_TO_HANDLE = REGISTER.register("too_hot_to_handle", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetOnFire(10)), new MSItemProperties().durability(350)));
	public static final DeferredItem<Item> CALEDSCRATCH = REGISTER.register("caledscratch", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> CALEDFWLCH = REGISTER.register("caledfwlch", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.WELSH_TIER, 6, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> ROYAL_DERINGER = REGISTER.register("royal_deringer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 7, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> CLAYMORE = REGISTER.register("claymore", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.6F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> CUTLASS_OF_ZILLYWAIR = REGISTER.register("cutlass_of_zillywair", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ZILLY_TIER, 6, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> REGISWORD = REGISTER.register("regisword", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 5, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties()));
	public static final DeferredItem<Item> CRUEL_FATE_CRUCIBLE = REGISTER.register("cruel_fate_crucible", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 4, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new MSItemProperties().durability(4096).rarity(Rarity.RARE))); //Special property in ServerEventHandler
	public static final DeferredItem<Item> SCARLET_RIBBITAR = REGISTER.register("scarlet_ribbitar", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 7, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> DOGG_MACHETE = REGISTER.register("dogg_machete", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new MSItemProperties().durability(1000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> COBALT_SABRE = REGISTER.register("cobalt_sabre", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 7, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetOnFire(30)), new MSItemProperties().durability(300)));
	public static final DeferredItem<Item> QUANTUM_SABRE = REGISTER.register("quantum_sabre", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 4, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1)))), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> SHATTER_BEACON = REGISTER.register("shatter_beacon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 7, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredItem<Item> SHATTER_BACON = REGISTER.register("shatter_bacon", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.MEAT_TIER, 7, -2.4F).efficiency(5.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SordDrop()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> SUBTRACTSHUMIDIRE_ZOMORRODNEGATIVE = REGISTER.register("subtractshumidire_zomorrodnegative", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 6, -2.6F).efficiency(5.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetOnFire(30)), new Item.Properties()));
	public static final DeferredItem<Item> MUSIC_SWORD = REGISTER.register("music_sword", () -> new MusicPlayerWeapon(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.4F).efficiency(5.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> PILLOW_TALK = REGISTER.register("pillow_talk", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ZILLY_TIER, 6, -2.4F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetOnFire(10)), new MSItemProperties().durability(2031).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> KRAKENS_EYE = REGISTER.register("krakens_eye", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PRISMARINE_TIER, 5, -2.6F).efficiency(15.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).set(new ItemRightClickEffect.PlayerPotionEffect(() -> new MobEffectInstance(MobEffects.CONDUIT_POWER, 120, 0), 1, 120)), new MSItemProperties().durability(650)));
	public static final DeferredItem<Item> CINNAMON_SWORD = REGISTER.register("cinnamon_sword", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 4, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	public static final DeferredItem<Item> UNION_BUSTER = REGISTER.register("union_buster", () -> new WeaponItem(new WeaponItem.Builder(Tiers.GOLD, 9, -3.5F).efficiency(1.0f).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep(), new OnHitEffect.SweepMultiEffect(new OnHitEffect.SpreadingKnockback(), new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MSEffects.SUSPICION, 1200, 3, false, false)))), new MSItemProperties().durability(505).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CHAINSAW_KATANA = REGISTER.register("chainsaw_katana", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.4F).efficiency(3.0F).set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.Sweep()), new MSItemProperties().durability(700)));
	public static final DeferredItem<Item> THORN_IN_YOUR_SIDE = REGISTER.register("thorn_in_your_side", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()), new Item.Properties()));
	public static final DeferredItem<Item> ROSE_PROTOCOL = REGISTER.register("rose_protocol", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.4F).efficiency(1.0F).set(MSItemTypes.SWORD_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.SetOnFire(6)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	
	
	//Knives
	public static final DeferredItem<Item> DAGGER = REGISTER.register("dagger", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(3)), new Item.Properties()));
	public static final DeferredItem<Item> DIAMOND_DAGGER = REGISTER.register("diamond_dagger", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)), new Item.Properties()));
	public static final DeferredItem<Item> PIGLINS_PRIDE = REGISTER.register("piglins_pride", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)).add(new OnHitEffect.TargetSpecificAdditionalDamage(4, () -> EntityType.PIGLIN)), new Item.Properties().fireResistant()));
	public static final DeferredItem<Item> BASILISK_BREATH_DRAGONSLAYER = REGISTER.register("basilisk_breath_dragonslayer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)).add(new OnHitEffect.TargetSpecificAdditionalDamage(6, MSEntityTypes.BASILISK)), new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> HALLOWED_SKEWER = REGISTER.register("hallowed_skewer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(9)), new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> GENESIS_GODSTABBER = REGISTER.register("genesis_godstabber", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.WELSH_TIER, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(9)), new MSItemProperties().durability(1561).fireResistant().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> NIFE = REGISTER.register("nife", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.SBAHJ_TIER, 1, -2.0F).add(new OnHitEffect.SordDrop()), new Item.Properties()));
	public static final DeferredItem<Item> LIGHT_OF_MY_KNIFE = REGISTER.register("light_of_my_knife", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.EMERALD_TIER, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)).add(new OnHitEffect.SetOnFire(35)), new Item.Properties()));
	public static final DeferredItem<Item> THOUSAND_DEGREE_KNIFE = REGISTER.register("thousand_degree_knife", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)).add(new OnHitEffect.SetOnFire(35)), new Item.Properties().fireResistant()));
	public static final DeferredItem<Item> STARSHARD_TRI_BLADE = REGISTER.register("starshard_tri_blade", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(9)), new Item.Properties()));
	public static final DeferredItem<Item> TOOTHRIPPER = REGISTER.register("toothripper", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)), new MSItemProperties().durability(1200)));
	public static final DeferredItem<Item> SHADOWRAZOR = REGISTER.register("shadowrazor", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new MSItemProperties().durability(1500)));
	public static final DeferredItem<Item> PRINCESS_PERIL = REGISTER.register("princess_peril", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 5, -2.0F).efficiency(1.0F).set(MSItemTypes.KNIFE_TOOL).add(new OnHitEffect.Backstab(4)).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new MSItemProperties().durability(1650)));
	...
	public static final DeferredItem<Item> CANDY_KEY = REGISTER.register("candy_key", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	...
	public static final DeferredItem<Item> LATCHMELTER = REGISTER.register("latchmelter", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(new OnHitEffect.SetOnFire(6)), new MSItemProperties().durability(450)));
	...
	public static final DeferredItem<Item> INNER_HEART = REGISTER.register("inner_heart", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(new OnHitEffect.SpawnParticles(ParticleTypes.HEART, 15, 2.0, 1.0, 2.0, 2.0)), new MSItemProperties().durability(460)));
	...
	public static final DeferredItem<Item> TRUE_BLUE = REGISTER.register("true_blue", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(new OnHitEffect.RandomDamage()), new MSItemProperties().durability(888)));
	public static final DeferredItem<Item> BLUE_BEAMS = REGISTER.register("blue_beams", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(new OnHitEffect.RandomDamage()), new MSItemProperties().durability(1616)));
	public static final DeferredItem<Item> INKSPLOCKER_UNLOCKER = REGISTER.register("inksplocker_unlocker", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 2, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties()));
	public static final DeferredItem<Item> INKSQUIDDER_DEPTHKEY = REGISTER.register("inksquidder_depthkey", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PRISMARINE_TIER, 0, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new Item.Properties()));
	...
	public static final DeferredItem<Item> YALDABAOTHS_KEYTON = REGISTER.register("yaldabaoths_keyton", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(new OnHitEffect.EnemyKnockback(2.0F)).add(new OnHitEffect.BossBuster()).add(OnHitEffect.playSound(MSSoundEvents.ITEM_BATON_ORCHESTRA)), new MSItemProperties().durability(4000).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> KEYTAR = REGISTER.register("keytar", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.0F).efficiency(1.0F).set(MSItemTypes.KEY_TOOL).add(OnHitEffect.playSound(SoundEvents.NOTE_BLOCK_GUITAR::value)).add(new OnHitEffect.SpawnParticles(ParticleTypes.NOTE, 10, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(265)));
	...
	//Batons
	public static final DeferredItem<Item> CONDUCTORS_BATON = REGISTER.register("conductors_baton", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).add(new OnHitEffect.PlaySound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.0F)).add(new OnHitEffect.SpawnParticles(ParticleTypes.NOTE, 10, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(200)));
	public static final DeferredItem<Item> SHARP_NOTE = REGISTER.register("sharp_note", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).add(new OnHitEffect.PlaySound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 2.0F)).add(new OnHitEffect.SpawnParticles(ParticleTypes.NOTE, 12, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(350)));
	public static final DeferredItem<Item> URANIUM_BATON = REGISTER.register("uranium_baton", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 0, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).add(new OnHitEffect.PlaySound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.8F)).add(new OnHitEffect.SpawnParticles(ParticleTypes.ITEM_SLIME, 10, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(285)));
	public static final DeferredItem<Item> WIND_WAKER = REGISTER.register("wind_waker", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).add(new OnHitEffect.EnemyKnockback(1.3F)).add(new OnHitEffect.PlaySound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.2F)).add(new OnHitEffect.SpawnParticles(ParticleTypes.NOTE, 8, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(750)));
	public static final DeferredItem<Item> CELESTIAL_FULCRUM = REGISTER.register("celestial_fulcrum", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 3, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).set(MagicRangedRightClickEffect.STANDARD_MAGIC).add(new OnHitEffect.EnemyKnockback(2.0F)).add(new OnHitEffect.PlaySound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 1.5F)).add(new OnHitEffect.SpawnParticles(ParticleTypes.NOTE, 14, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(1200)));
	public static final DeferredItem<Item> HYMN_FOR_HORRORTERRORS = REGISTER.register("hymn_for_horrorterrors", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.0F).set(MSItemTypes.BATON_TOOL).add(new OnHitEffect.HorrorTerror()).set(MagicRangedRightClickEffect.HORRORTERROR_MAGIC).add(new OnHitEffect.EnemyKnockback(2.0F)).add(new OnHitEffect.PlaySound(MSSoundEvents.ITEM_BATON_ORCHESTRA, 1, 0.2F)).add(new OnHitEffect.SpawnParticles(ParticleTypes.SCULK_SOUL, 15, 1.0, 2.0, 1.0, 2.0)), new MSItemProperties().durability(2500).rarity(Rarity.RARE)));
	
	
	//Axes
	public static final DeferredItem<Item> BATLEACKS = REGISTER.register("batleacks", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.SBAHJ_TIER, 3, -3.5F).efficiency(1.0F).set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.SordDrop()), new Item.Properties()));
	...
	public static final DeferredItem<Item> MELONSBANE = REGISTER.register("melonsbane", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 8, -3.0F).efficiency(3.0F).disableShield().set(MSItemTypes.AXE_TOOL).set(new DestroyBlockEffect.ExtraHarvests(true, 0.6F, 20, () -> Items.MELON_SLICE, () -> Blocks.MELON)), new MSItemProperties().durability(400)));
	public static final DeferredItem<Item> CROP_CHOP = REGISTER.register("crop_chop", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 7, -3.0F).efficiency(3.0F).disableShield().set(MSItemTypes.AXE_TOOL).set(new DestroyBlockEffect.DoubleFarm()), new MSItemProperties().durability(800)));
	public static final DeferredItem<Item> THE_LAST_STRAW = REGISTER.register("the_last_straw", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 9, -3.0F).efficiency(3.0F).disableShield().set(MSItemTypes.AXE_TOOL).set(new DestroyBlockEffect.DoubleFarm()), new MSItemProperties().durability(950)));
	...
	public static final DeferredItem<Item> CANDY_BATTLEAXE = REGISTER.register("candy_battleaxe", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 8, -3.0F).efficiency(2.0F).disableShield().set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new MSItemProperties().durability(111)));
	...
	public static final DeferredItem<Item> STEEL_EDGE_CANDYCUTTER = REGISTER.register("steel_edge_candycutter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 8, -3.0F).efficiency(3.0F).disableShield().set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new MSItemProperties().durability(800).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> SURPRISE_AXE = REGISTER.register("surprise_axe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -3.0F).efficiency(6.0F).disableShield().set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.KundlerSurprise()), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> SHOCK_AXE = REGISTER.register("shock_axe", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.BATTERY_TIER, 8, -3.0F).efficiency(6.0F).disableShield().set(MSItemTypes.AXE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.SHOCK_AXE_UNPOWERED)).add(new OnHitEffect.DropFoeItem()).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new MSItemProperties().durability(800)));
	public static final DeferredItem<Item> SHOCK_AXE_UNPOWERED = REGISTER.register("shock_axe_unpowered", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.BATTERY_TIER, 6, -3.0F).efficiency(6.0F).disableShield().set(MSItemTypes.AXE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.SHOCK_AXE)), new MSItemProperties().durability(800)));
	...
	public static final DeferredItem<Item> LORENTZ_DISTRANSFORMATIONER = REGISTER.register("lorentz_distransformationer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -3.0F).efficiency(7.0F).disableShield().set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.SpaceTeleport()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> HEPHAESTUS_LUMBERJACK = REGISTER.register("hephaestus_lumberjack", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 7, -3.0F).efficiency(9.0F).disableShield().set(MSItemTypes.AXE_TOOL).add(new OnHitEffect.SetOnFire(30)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	//Dice
	public static final DeferredItem<Item> FLUORITE_OCTET = REGISTER.register("fluorite_octet", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 4, -3.0F).efficiency(1.0F).add(new OnHitEffect.RandomDamage()), new MSItemProperties().durability(4096).rarity(Rarity.EPIC)));
	
	//Claws
	public static final DeferredItem<Item> MAKESHIFT_CLAWS_DRAWN = REGISTER.register("makeshift_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, 1, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.MAKESHIFT_CLAWS_SHEATHED)), new MSItemProperties().durability(200)));
	public static final DeferredItem<Item> MAKESHIFT_CLAWS_SHEATHED = REGISTER.register("makeshift_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.STONE, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.MAKESHIFT_CLAWS_DRAWN)), new MSItemProperties().durability(200)));
	public static final DeferredItem<Item> CAT_CLAWS_DRAWN = REGISTER.register("cat_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.CAT_CLAWS_SHEATHED)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> CAT_CLAWS_SHEATHED = REGISTER.register("cat_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.CAT_CLAWS_DRAWN)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> COFFEE_CLAWS_DRAWN = REGISTER.register("coffee_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 2, -1.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.COFFEE_CLAWS_SHEATHED)), new MSItemProperties().durability(350)));
	public static final DeferredItem<Item> COFFEE_CLAWS_SHEATHED = REGISTER.register("coffee_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.COFFEE_CLAWS_DRAWN)), new MSItemProperties().durability(350)));
	...
	public static final DeferredItem<Item> ATOMIKITTY_KATAR_DRAWN = REGISTER.register("atomikitty_katar_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 1, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ATOMIKITTY_KATAR_SHEATHED)).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1)))), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> ATOMIKITTY_KATAR_SHEATHED = REGISTER.register("atomikitty_katar_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.ATOMIKITTY_KATAR_DRAWN)), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> SKELETONIZER_DRAWN = REGISTER.register("skeletonizer_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.SKELETONIZER_SHEATHED)), new MSItemProperties().durability(750)));
	public static final DeferredItem<Item> SKELETONIZER_SHEATHED = REGISTER.register("skeletonizer_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.SKELETONIZER_DRAWN)), new MSItemProperties().durability(750)));
	public static final DeferredItem<Item> SKELETON_DISPLACER_DRAWN = REGISTER.register("skeleton_displacer_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 6, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.SKELETON_DISPLACER_SHEATHED)).add(new OnHitEffect.TargetSpecificAdditionalDamage(4, () -> EntityType.SKELETON)), new MSItemProperties().durability(1250)));
	public static final DeferredItem<Item> SKELETON_DISPLACER_SHEATHED = REGISTER.register("skeleton_displacer_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.SKELETON_DISPLACER_DRAWN)), new MSItemProperties().durability(1250)));
	public static final DeferredItem<Item> TEARS_OF_THE_ENDERLICH_DRAWN = REGISTER.register("tears_of_the_enderlich_drawn", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.TEARS_OF_THE_ENDERLICH_SHEATHED)).add(new OnHitEffect.TargetSpecificAdditionalDamage(6, MSEntityTypes.LICH)), new MSItemProperties().durability(2000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> TEARS_OF_THE_ENDERLICH_SHEATHED = REGISTER.register("tears_of_the_enderlich_sheathed", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, -4, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.TEARS_OF_THE_ENDERLICH_DRAWN)), new MSItemProperties().durability(2000).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> LION_LACERATORS_DRAWN = REGISTER.register("lion_lacerators_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.LION_LACERATORS_SHEATHED)).add(new OnHitEffect.TargetSpecificAdditionalDamage(4, MSEntityTypes.LICH)), new MSItemProperties().durability(2031).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> LION_LACERATORS_SHEATHED = REGISTER.register("lion_lacerators_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, -4, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.LION_LACERATORS_DRAWN)), new MSItemProperties().durability(2031).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> ACTION_CLAWS_DRAWN = REGISTER.register("action_claws_drawn", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.CLAWS_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ACTION_CLAWS_SHEATHED)), new MSItemProperties().durability(4096).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> ACTION_CLAWS_SHEATHED = REGISTER.register("action_claws_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, -1, -1.0F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.ACTION_CLAWS_DRAWN)), new MSItemProperties().durability(4096).rarity(Rarity.RARE)));
	
	
	//Chainsaws
	public static final DeferredItem<Item> LIPSTICK_CHAINSAW = REGISTER.register("lipstick_chainsaw", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.LIPSTICK)), new MSItemProperties().durability(250)));
	public static final DeferredItem<Item> LIPSTICK = REGISTER.register("lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.LIPSTICK_CHAINSAW)), new MSItemProperties().durability(250)));
	public static final DeferredItem<Item> CAKESAW = REGISTER.register("cakesaw", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.CAKESAW_LIPSTICK)).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	public static final DeferredItem<Item> CAKESAW_LIPSTICK = REGISTER.register("cakesaw_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(CAKESAW)), new MSItemProperties().durability(450)));
	public static final DeferredItem<Item> MAGENTA_MAULER = REGISTER.register("magenta_mauler", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.MAGENTA_MAULER_LIPSTICK)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> MAGENTA_MAULER_LIPSTICK = REGISTER.register("magenta_mauler_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.MAGENTA_MAULER)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> THISTLEBLOWER = REGISTER.register("thistleblower", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -1.0F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.THISTLEBLOWER_LIPSTICK)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> THISTLEBLOWER_LIPSTICK = REGISTER.register("thistleblower_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.THISTLEBLOWER)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> HAND_CRANKED_VAMPIRE_ERASER = REGISTER.register("hand_cranked_vampire_eraser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.HAND_CRANKED_VAMPIRE_ERASER_LIPSTICK)), new MSItemProperties().durability(250)));
	public static final DeferredItem<Item> HAND_CRANKED_VAMPIRE_ERASER_LIPSTICK = REGISTER.register("hand_cranked_vampire_eraser_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.HAND_CRANKED_VAMPIRE_ERASER)), new MSItemProperties().durability(250)));
	public static final DeferredItem<Item> EMERALD_IMMOLATOR = REGISTER.register("emerald_immolator", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.EMERALD_TIER, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.EMERALD_IMMOLATOR_LIPSTICK)).add(new OnHitEffect.SetOnFire(5)), new MSItemProperties().durability(1024)));
	public static final DeferredItem<Item> EMERALD_IMMOLATOR_LIPSTICK = REGISTER.register("emerald_immolator_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.EMERALD_IMMOLATOR)), new MSItemProperties().durability(1024)));
	public static final DeferredItem<Item> OBSIDIATOR = REGISTER.register("obsidiator", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 4, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.OBSIDIATOR_LIPSTICK)), new MSItemProperties().durability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> OBSIDIATOR_LIPSTICK = REGISTER.register("obsidiator_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.OBSIDIATOR)), new MSItemProperties().durability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> DEVILS_DELIGHT = REGISTER.register("devils_delight", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.DEVILS_DELIGHT_LIPSTICK)).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new MSItemProperties().durability(1536).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> DEVILS_DELIGHT_LIPSTICK = REGISTER.register("devils_delight_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.DEVILS_DELIGHT)), new MSItemProperties().durability(1536).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> DEMONBANE_RAGRIPPER = REGISTER.register("demonbane_ragripper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 3, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.DEMONBANE_RAGRIPPER_LIPSTICK)).add(OnHitEffect.onCrit(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 100, 0)))), new MSItemProperties().durability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> DEMONBANE_RAGRIPPER_LIPSTICK = REGISTER.register("demonbane_ragripper_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.DEMONBANE_RAGRIPPER)), new MSItemProperties().durability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> FROSTTOOTH = REGISTER.register("frosttooth", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ICE_TIER, 5, -1.5F).efficiency(10.0F).set(MSItemTypes.CHAINSAW_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.FROSTTOOTH_LIPSTICK)).add(new OnHitEffect.IceShard()), new MSItemProperties().durability(1536)));
	public static final DeferredItem<Item> FROSTTOOTH_LIPSTICK = REGISTER.register("frosttooth_lipstick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, -1, -0.5F).efficiency(10.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.FROSTTOOTH)), new MSItemProperties().durability(1536)));
	...
	public static final DeferredItem<Item> LANEC = REGISTER.register("lanec", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.SBAHJ_TIER, 3, -2.8F).efficiency(2.0F).set(MSItemTypes.LANCE_TOOL).add(new OnHitEffect.SordDrop()), new Item.Properties()));
	...
	public static final DeferredItem<Item> POGO_LANCE = REGISTER.register("pogo_lance", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.POGO_TIER, 4, -2.8F).efficiency(2.0F).set(MSItemTypes.LANCE_TOOL).add(new OnHitEffect.MutualKnockback(0.75F)), new Item.Properties()));
	public static final DeferredItem<Item> LANCELOTS_LOLLY = REGISTER.register("lancelots_lolly", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 6, -2.8F).efficiency(2.0F).set(MSItemTypes.LANCE_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	...
	public static final DeferredItem<Item> SKY_PIERCER = REGISTER.register("sky_piercer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 5, -2.8F).efficiency(2.0F).set(MSItemTypes.LANCE_TOOL).add(new OnHitEffect.SetOnFire(30)), new Item.Properties().fireResistant()));
	...
	public static final DeferredItem<Item> CIGARETTE_LANCE = REGISTER.register("cigarette_lance", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 5, -2.8F).efficiency(2.0F).set(MSItemTypes.LANCE_TOOL).add(new OnHitEffect.RandomDamage()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	//Fans
	public static final DeferredItem<Item> FAN = REGISTER.register("fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(1.5F)), new Item.Properties()));
	public static final DeferredItem<Item> CANDY_FAN = REGISTER.register("candy_fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(1.5F)).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	public static final DeferredItem<Item> SPINES_OF_FLUTHLU = REGISTER.register("spines_of_fluthlu", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(1.5F)).add(new OnHitEffect.HorrorTerror()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> RAZOR_FAN = REGISTER.register("razor_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(1.5F)), new Item.Properties()));
	public static final DeferredItem<Item> MOTOR_FAN = REGISTER.register("motor_fan", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CORUNDUM_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(2.0F)), new Item.Properties()));
	public static final DeferredItem<Item> ATOMIC_VAPORIZER = REGISTER.register("atomic_vaporizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(2.0F)).add(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.WITHER, 100, 1))), new MSItemProperties().durability(2048)));
	public static final DeferredItem<Item> SHAVING_FAN = REGISTER.register("shaving_fan", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(1.5F)), new Item.Properties()));
	public static final DeferredItem<Item> FIRESTARTER = REGISTER.register("firestarter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).add(new OnHitEffect.EnemyKnockback(1.5F)).add(new OnHitEffect.SetOnFire(35)), new MSItemProperties().durability(300)));
	public static final DeferredItem<Item> STAR_RAY = REGISTER.register("star_ray", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 1, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(1)).add(new OnHitEffect.EnemyKnockback(1.5F)).add(new OnHitEffect.SetOnFire(35)), new Item.Properties()));
	public static final DeferredItem<Item> TYPHONIC_TRIVIALIZER = REGISTER.register("typhonic_trivializer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.DENIZEN_TIER, 2, -1.0F).efficiency(1.5F).set(MSItemTypes.FAN_TOOL).set(new ItemRightClickEffect.ExtinguishFire(3)).add(OnHitEffect.BREATH_LEVITATION_AOE).add(new OnHitEffect.EnemyKnockback(2.0F)), new Item.Properties().rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> OW_THE_EDGE = REGISTER.register("ow_the_edge", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.SBAHJ_TIER, 3, -3.0F).efficiency(1.0F).set(MSItemTypes.SICKLE_TOOL).add(new OnHitEffect.SordDrop()), new Item.Properties()));
	...
	public static final DeferredItem<Item> CLAW_OF_NRUBYIGLITH = REGISTER.register("claw_of_nrubyiglith", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.HORRORTERROR_TIER, 6, -2.2F).efficiency(4.0F).disableShield().set(MSItemTypes.SICKLE_TOOL).add(new OnHitEffect.HorrorTerror()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CANDY_SICKLE = REGISTER.register("candy_sickle", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 6, -2.2F).efficiency(2.5F).disableShield().set(MSItemTypes.SICKLE_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	...
	public static final DeferredItem<Item> MARASCHINO_CHERRY_SCYTHE = REGISTER.register("maraschino_cherry_scythe", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 6, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SCYTHE_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	public static final DeferredItem<Item> KISSY_CUTIE_HEART_SPLITTER = REGISTER.register("kissy_cutie_heart_splitter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 4, -2.6F).efficiency(10.0F).disableShield().set(MSItemTypes.SCYTHE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.KISSY_CUTIE_HEART_HITTER)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> MUTANT_CUTIE_CELL_CUTTER = REGISTER.register("mutant_cutie_cell_cutter", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 4, -2.6F).efficiency(10.0F).disableShield().set(MSItemTypes.SCYTHE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.MUTANT_CUTIE_CELL_PUTTER)).add(OnHitEffect.playSound(() -> SoundEvents.CAT_PURREOW)), new MSItemProperties().durability(2000).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> EIGHTBALL_SCYTHE = REGISTER.register("eightball_scythe", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SCYTHE_TOOL).add(new OnHitEffect.RandomDamage()).set(new ItemRightClickEffect.Eightball()), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> TIME_FLAYER = REGISTER.register("time_flayer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SCYTHE_TOOL).add(new OnHitEffect.RandomDamage()), new Item.Properties().rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> SUNRAY_HARVESTER = REGISTER.register("sunray_harvester", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 4, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SCYTHE_TOOL).add(new OnHitEffect.SetOnFire(35)), new MSItemProperties().durability(1200)));
	public static final DeferredItem<Item> GREEN_SUN_RAYREAPER = REGISTER.register("green_sun_rayreaper", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 7, -2.6F).efficiency(1.5F).disableShield().set(MSItemTypes.SCYTHE_TOOL).add(new OnHitEffect.SetOnFire(10)), new Item.Properties().fireResistant().rarity(Rarity.RARE)));
	...
	public static final DeferredItem<Item> HELLBRINGERS_HOE_INACTIVE = REGISTER.register("hellbringers_hoe_inactive", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 3, -2.4F).efficiency(10.0F).set(MSItemTypes.SCYTHE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.HELLBRINGERS_HOE_ACTIVE)), new Item.Properties()));
	public static final DeferredItem<Item> HELLBRINGERS_HOE_ACTIVE = REGISTER.register("hellbringers_hoe_active", () -> new WeaponItem(new WeaponItem.Builder(Tiers.NETHERITE, 2, -2.4F).efficiency(10.0F).set(MSItemTypes.SCYTHE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.HELLBRINGERS_HOE_INACTIVE)).add(new OnHitEffect.SetOnFire(10)), new Item.Properties()));
	...
	public static final DeferredItem<Item> STALE_BAGUETTE = REGISTER.register("stale_baguette", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.SpawnBreadcrumbs()).setEating(FinishUseItemEffect.SPAWN_BREADCRUMBS, FinishUseItemEffect.foodEffect(3, 0.2F)), new Item.Properties()));
	...
	public static final DeferredItem<Item> RED_EYES = REGISTER.register("red_eyes", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 6, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.POISON, 140, 0))), new Item.Properties()));
	...
	public static final DeferredItem<Item> CLUB_ZERO = REGISTER.register("club_zero", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ICE_TIER, 5, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.IceShard()), new Item.Properties()));
	...
	public static final DeferredItem<Item> DESOLATOR_MACE = REGISTER.register("desolator_mace", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 1, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.ArmorBypassingDamageMod(4, EnumAspect.VOID)), new MSItemProperties().durability(2048).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> BLAZING_GLORY = REGISTER.register("blazing_glory", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.SetOnFire(35)), new MSItemProperties().durability(750)));
	...
	public static final DeferredItem<Item> TOFFEE_CLUB = REGISTER.register("toffee_club", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 6, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	
	public static final DeferredItem<Item> HORSE_HITCHER = REGISTER.register("horse_hitcher", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ACE_OF_SPADES)), new MSItemProperties().durability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_SPADES = REGISTER.register("ace_of_spades", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.HORSE_HITCHER)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> CLUB_OF_FELONY = REGISTER.register("club_of_felony", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 7, -2.8F).efficiency(2.0F).set(MSItemTypes.CLUB_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ACE_OF_CLUBS)), new MSItemProperties().durability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_CLUBS = REGISTER.register("ace_of_clubs", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.CLUB_OF_FELONY)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> CUESTICK = REGISTER.register("cuestick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.0F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ACE_OF_DIAMONDS)), new MSItemProperties().durability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_DIAMONDS = REGISTER.register("ace_of_diamonds", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.CUESTICK)), new MSItemProperties().durability(500)));
	public static final DeferredItem<Item> TV_ANTENNA = REGISTER.register("tv_antenna", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -1.4F).efficiency(2.0F).set(MSItemTypes.MISC_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ACE_OF_HEARTS)), new MSItemProperties().durability(500).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ACE_OF_HEARTS = REGISTER.register("ace_of_hearts", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.PAPER_TIER, 0, -1.8F).efficiency(0.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.TV_ANTENNA)), new MSItemProperties().durability(500)));
	
	//Staffs
	public static final DeferredItem<Item> BO_STAFF = REGISTER.register("bo_staff", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 0, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.EnemyKnockback(0.5F)), new MSItemProperties().durability(100)));
	public static final DeferredItem<Item> BAMBOO_BEATSTICK = REGISTER.register("bamboo_beatstick", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 4, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.EnemyKnockback(0.5F)), new MSItemProperties().durability(350)));
	public static final DeferredItem<Item> TELESCOPIC_BEATDOWN_BRUISER = REGISTER.register("telescopic_beatdown_bruiser", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.STAFF_TOOL).add(new OnHitEffect.EnemyKnockback(0.5F)), new MSItemProperties().durability(550)));
	public static final DeferredItem<Item> ION_DESTABILIZER = REGISTER.register("ion_destabilizer", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 2, -2.0F).efficiency(4.0F).set(MSItemTypes.STAFF_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.EnemyKnockback(0.5F)).add(new OnHitEffect.SetOnFire(4)).add(new OnHitEffect.SpawnParticles(ParticleTypes.ITEM_SLIME, 6, 2.0, 1.0, 2.0, 1.0)), new MSItemProperties().durability(1400).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> BARBERS_MAGIC_TOUCH = REGISTER.register("barbers_magic_touch", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 4, -2.8F).efficiency(1.0F).set(MSItemTypes.CLUB_TOOL).add(new OnHitEffect.Sweep()).add(new OnHitEffect.EnemyKnockback(0.5F)).set(MagicAOERightClickEffect.STANDARD_MAGIC), new MSItemProperties().durability(660)));
	...
	public static final DeferredItem<Item> WHITE_KINGS_SCEPTER = REGISTER.register("white_kings_scepter", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 8, -2.8F).efficiency(4.0F).set(MSItemTypes.CLUB_TOOL).set(new ItemRightClickEffect.SummonFireball()), new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredItem<Item> BLACK_KINGS_SCEPTER = REGISTER.register("black_kings_scepter", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.REGI_TIER, 8, -2.8F).efficiency(4.0F).set(MSItemTypes.CLUB_TOOL).set(new ItemRightClickEffect.SummonFireball()), new Item.Properties().rarity(Rarity.EPIC)));
	...
	public static final DeferredItem<Item> BEAR_POKING_STICK = REGISTER.register("bear_poking_stick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).add(OnHitEffect.notAtPlayer(new OnHitEffect.EnemyPotionEffect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 140, 1)))), new MSItemProperties().durability(150)));
	...
	public static final DeferredItem<Item> UPPER_CRUST_CRUST_CANE = REGISTER.register("upper_crust_crust_cane", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.ORGANIC_TIER, 3, -2.0F).efficiency(2.0F).set(MSItemTypes.CANE_TOOL).add(new OnHitEffect.SpawnBreadcrumbs()).setEating(FinishUseItemEffect.SPAWN_BREADCRUMBS, FinishUseItemEffect.foodEffect(4, 0.5F)), new Item.Properties()));
	...
	public static final DeferredItem<Item> KISSY_CUTIE_HEART_HITTER = REGISTER.register("kissy_cutie_heart_hitter", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 2, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.KISSY_CUTIE_HEART_SPLITTER)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> MUTANT_CUTIE_CELL_PUTTER = REGISTER.register("mutant_cutie_cell_putter", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 2, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.MUTANT_CUTIE_CELL_CUTTER)).add(OnHitEffect.playSound(() -> SoundEvents.CAT_PURREOW)), new MSItemProperties().durability(2000).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> CANDY_CANE = REGISTER.register("candy_cane", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).add(new OnHitEffect.SetCandyDropFlag()).setEating(FinishUseItemEffect.foodEffect(2, 0.3F), FinishUseItemEffect.SHARPEN_CANDY_CANE), new Item.Properties()));
	public static final DeferredItem<Item> SHARP_CANDY_CANE = REGISTER.register("sharp_candy_cane", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 5, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	...
	public static final DeferredItem<Item> DRAGON_CANE = REGISTER.register("dragon_cane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 7, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.DRAGON_CANE_UNSHEATHED)), new MSItemProperties().durability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> DRAGON_CANE_UNSHEATHED = REGISTER.register("dragon_cane_unsheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.DRAGON_CANE)), new MSItemProperties().durability(2048).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT = REGISTER.register("chancewyrms_extra_fortunate_stabbing_implement", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 6, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT_UNSHEATHED)), new MSItemProperties().durability(4096).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT_UNSHEATHED = REGISTER.register("chancewyrms_extra_fortunate_stabbing_implement_unsheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.CHANCEWYRMS_EXTRA_FORTUNATE_STABBING_IMPLEMENT)).add(new OnHitEffect.RandomDamage()), new MSItemProperties().durability(4096).rarity(Rarity.RARE)));
	public static final DeferredItem<Item> LESS_PROPER_WALKING_STICK = REGISTER.register("less_proper_walking_stick", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.LESS_PROPER_WALKING_STICK_SHEATHED)), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> LESS_PROPER_WALKING_STICK_SHEATHED = REGISTER.register("less_proper_walking_stick_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 3, -2.0F).efficiency(1.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.LESS_PROPER_WALKING_STICK)), new MSItemProperties().durability(600)));
	public static final DeferredItem<Item> ROCKEFELLERS_WALKING_BLADECANE = REGISTER.register("rockefellers_walking_bladecane", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 5, -2.0F).efficiency(1.0F).set(MSItemTypes.CANE_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.ROCKEFELLERS_WALKING_BLADECANE_SHEATHED)), new MSItemProperties().durability(800).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> ROCKEFELLERS_WALKING_BLADECANE_SHEATHED = REGISTER.register("rockefellers_walking_bladecane_sheathed", () -> new WeaponItem(new WeaponItem.Builder(Tiers.WOOD, 5, -2.0F).efficiency(1.0F).set(new ItemRightClickEffect.SwitchTo(MSItems.ROCKEFELLERS_WALKING_BLADECANE)), new MSItemProperties().durability(800).rarity(Rarity.UNCOMMON)));
	...
	public static final DeferredItem<Item> MELONBALLER = REGISTER.register("melonballer", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 2, -2.4F).efficiency(1.0F).set(MSItemTypes.SPOON_TOOL).set(new RightClickBlockEffect.ScoopBlock(() -> Blocks.MELON)), new MSItemProperties().durability(500)));
	...
	public static final DeferredItem<Item> TERRAIN_FLATENATOR = REGISTER.register("terrain_flatenator", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 3, -2.4F).efficiency(10.0F).set(MSItemTypes.SPOON_TOOL).set(new FarmineEffect(Integer.MAX_VALUE, 50)), new MSItemProperties().durability(1024)));
	...
	public static final DeferredItem<Item> CROCKER_SPOON = REGISTER.register("crocker_spoon", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 5, -2.4F).efficiency(1.0F).set(MSItemTypes.SHOVEL_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.CROCKER_FORK)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> CROCKER_FORK = REGISTER.register("crocker_fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.DIAMOND, 6, -2.6F).efficiency(1.0F).set(MSItemTypes.FORK_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.CROCKER_SPOON)), new Item.Properties().rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<Item> EDISONS_FURY = REGISTER.register("edisons_fury", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.BATTERY_TIER, 7, -2.6F).efficiency(1.0F).set(MSItemTypes.FORK_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.EDISONS_SERENITY)).add(new OnHitEffect.DropFoeItem()).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties()));
	public static final DeferredItem<Item> EDISONS_SERENITY = REGISTER.register("edisons_serenity", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.BATTERY_TIER, 7, -2.6F).efficiency(1.0F).set(MSItemTypes.FORK_TOOL).set(new ItemRightClickEffect.SwitchTo(MSItems.EDISONS_FURY)), new Item.Properties()));
	...
	public static final DeferredItem<Item> CANDY_FORK = REGISTER.register("candy_fork", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.CANDY_TIER, 5, -2.6F).efficiency(1.0F).set(MSItemTypes.FORK_TOOL).add(new OnHitEffect.SetCandyDropFlag()), new Item.Properties()));
	...
	public static final DeferredItem<Item> ELECTRIC_FORK = REGISTER.register("electric_fork", () -> new WeaponItem(new WeaponItem.Builder(Tiers.IRON, 6, -2.6F).efficiency(1.0F).set(MSItemTypes.FORK_TOOL).add(new OnHitEffect.DropFoeItem()).add(InventoryTickEffect.DROP_WHEN_IN_WATER).add(OnHitEffect.playSound(MSSoundEvents.EVENT_ELECTRIC_SHOCK, 0.6F, 1.0F)), new Item.Properties()));
	...
	public static final DeferredItem<Item> DEVIL_FORK = REGISTER.register("devil_fork", () -> new WeaponItem(new WeaponItem.Builder(MSItemTypes.URANIUM_TIER, 6, -2.6F).efficiency(1.0F).set(MSItemTypes.FORK_TOOL).add(new OnHitEffect.SetOnFire(35)), new Item.Properties()));
