...
public class GodTierArmorItem extends ArmorItem
{
	...
	public BipedModel getArmorModel(EntityLivingBase entityLiving, ItemStack stack, EquipmentSlotType armorSlot, BipedModel _default)
	{
		...
		GodTierAbstractModel model = GTAArmorModels.models.get(heroClass);
		...
		model.isRiding = _default.isSitting;
...
//
//import static com.cibernet.minestuckgodtier.items.GTAItems.gtHood;
//import static com.cibernet.minestuckgodtier.items.GTAItems.gtPants;
//import static com.cibernet.minestuckgodtier.items.GTAItems.gtShirt;
//
//import com.cibernet.minestuckgodtier.MinestuckGodTier;
//import com.cibernet.minestuckgodtier.models.armor.ModelGTAbstract;
//import com.cibernet.minestuckgodtier.util.GTAArmorModels;
...
//			return super.getArmorModel(entityLiving, stack, armorSlot, _default);
//
//		ModelGTAbstract model = GTAArmorModels.models.get(heroClass);
//
//		model.heroAspect = heroAspect;
//
