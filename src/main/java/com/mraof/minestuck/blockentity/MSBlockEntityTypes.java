...
public class MSBlockEntityTypes
{
	...
	public static final Supplier<BlockEntityType<AutowidgetBlockEntity>> AUTOWIDGET = REGISTER.register("autowidget", () -> BlockEntityType.Builder.of(AutowidgetBlockEntity::new, MSBlocks.AUTOWIDGET.get()).build(null));
