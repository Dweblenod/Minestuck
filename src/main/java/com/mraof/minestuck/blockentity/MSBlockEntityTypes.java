...
public class MSBlockEntityTypes
{
	...
	public static final Supplier<BlockEntityType<ConwayGeneratorBlockEntity>> CONWAY_GENERATOR = REGISTER.register("conway_generator", () -> BlockEntityType.Builder.of(ConwayGeneratorBlockEntity::new, MSBlocks.CONWAY_GENERATOR.get()).build(null));
