...
public class AutowidgetMenu extends AbstractContainerMenu
{
	...
	public AutowidgetMenu(int windowId, Inventory playerInventory)
	{
		this(MSMenuTypes.AUTOWIDGET.get(), windowId, playerInventory, new ItemStackHandler(2), DataSlot.standalone(), ContainerLevelAccess.NULL);
	}
	
	public AutowidgetMenu(int windowId, Inventory playerInventory, IItemHandler inventory, DataSlot fuelHolder, ContainerLevelAccess access)
	{
		this(MSMenuTypes.AUTOWIDGET.get(), windowId, playerInventory, inventory, fuelHolder, access);
	}
	
	public AutowidgetMenu(MenuType<? extends AutowidgetMenu> type, int windowId, Inventory playerInventory, IItemHandler inventory, DataSlot fuelHolder, ContainerLevelAccess access)
	{
		super(type, windowId);
	...
	{
		return stillValid(levelAccess, player, MSBlocks.AUTOWIDGET.get());
	}
