...
public class MinestuckGristCostsProvider extends RecipeProvider
{
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> recipeSaver)
	{
		...
		WeaponGristCostRecipeBuilder.of(MSItems.CAT_CLAWS_DRAWN).grist(BUILD, 3,0).grist(RUST, 1,0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CAT_CLAWS_SHEATHED).grist(BUILD, 3,0).grist(RUST, 1,0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.LIPSTICK_CHAINSAW).grist(BUILD, 2,0).grist(MARBLE, 1,0).grist(SHALE, 3,0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.JOUSTING_LANCE).grist(RUST, 1, 0).grist(QUARTZ, 0, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CIGARETTE_LANCE).grist(SHALE, 2,0).grist(TAR, 3,0).grist(DIAMOND, 0, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.LUCERNE_HAMMER).grist(BUILD, 4,0).grist(RUST, 1,0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.LUCERNE_HAMMER_OF_UNDYING).grist(BUILD, 150).grist(DIAMOND, 20).grist(CHALK, 20).grist(MARBLE, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.TYPHONIC_TRIVIALIZER).grist(BUILD, 1000).grist(RUBY, 150).grist(DIAMOND, 50).grist(SHALE, 200).grist(URANIUM, 5).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.CLAW_HAMMER).grist(BUILD, 8).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SLEDGE_HAMMER).grist(BUILD, 10).grist(SHALE, 4).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.MAILBOX).grist(BUILD, 16).grist(MERCURY, 3).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BLACKSMITH_HAMMER).grist(RUST, 8).grist(SULFUR, 9).grist(CAULK, 5).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.POGO_HAMMER).grist(BUILD, 20).grist(SHALE, 16).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.WRINKLEFUCKER).grist(BUILD, 32).grist(SHALE, 17).grist(TAR, 19).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.TELESCOPIC_SASSACRUSHER).grist(SHALE, 39).grist(TAR, 18).grist(MERCURY, 23).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.DEMOCRATIC_DEMOLITIONER).grist(BUILD, 50).grist(GOLD, 5).grist(MARBLE, 25).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.REGI_HAMMER).grist(AMETHYST, 25).grist(TAR, 70).grist(GOLD, 34).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.FEAR_NO_ANVIL).grist(BUILD, 999).grist(GARNET, 150).grist(DIAMOND, 54).grist(GOLD, 61).grist(QUARTZ, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.MELT_MASHER).grist(BUILD, 1000).grist(TAR, 400).grist(GARNET, 200).grist(DIAMOND, 340).grist(GOLD, 100).grist(RUBY, 150).grist(SULFUR, 450).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.ESTROGEN_EMPOWERED_EVERYTHING_ERADICATOR).grist(BUILD, 8000).grist(SHALE, 1280).grist(URANIUM, 640).grist(RUST, 300).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.EEEEEEEEEEEE).grist(ARTIFACT, -100).grist(BUILD, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.MWRTHWL).grist(BUILD, 10000).grist(GOLD, 1000).grist(RUST, 2500).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.PAPER_SWORD).grist(BUILD, 12).grist(TAR, 8).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SWONGE).grist(IODINE, 6).grist(QUARTZ, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CACTACEAE_CUTLASS).grist(AMBER, 7).grist(MARBLE, 2).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BEEF_SWORD).grist(IODINE, 55).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.IRRADIATED_STEAK_SWORD).grist(IODINE, 55).grist(TAR, 10).grist(URANIUM, 8).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SORD).grist(BUILD, 0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.FROSTY_MACUAHUITL).grist(BUILD, 45).grist(COBALT, 45).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.FIRE_POKER).grist(AMBER, 41).grist(RUBY, 14).grist(SULFUR, 38).grist(GOLD, 3).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CLAYMORE).grist(BUILD, 400).grist(RUST, 240).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.TOO_HOT_TO_HANDLE).grist(AMBER, 10).grist(RUBY, 15).grist(SULFUR, 10).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.REGISWORD).grist(AMETHYST, 27).grist(TAR, 62).grist(GOLD, 38).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CRUEL_FATE_CRUCIBLE).grist(BUILD, 1200).grist(TAR, 300).grist(COBALT, 100).grist(GOLD, 50).grist(QUARTZ, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.UNBREAKABLE_KATANA).grist(BUILD, 1800).grist(URANIUM, 93).grist(QUARTZ, 155).grist(RUBY, 84).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.ANGEL_APOCALYPSE).grist(BUILD, 150).grist(AMBER, 5).grist(QUARTZ, 20).grist(GOLD, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.COBALT_SABRE).grist(BUILD, 1300).grist(URANIUM, 90).grist(COBALT, 175).grist(DIAMOND, 30).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.QUANTUM_SABRE).grist(BUILD, 413).grist(URANIUM, 61).grist(CAULK, 52).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SHATTER_BEACON).grist(BUILD, 25).grist(COBALT, 15).grist(DIAMOND, 150).grist(URANIUM, 400).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.SILVER_SPOON).grist(BUILD, 6, 0).grist(MERCURY, 4,0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.MELONBALLER).grist(BUILD, 30).grist(RUBY, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SIGHTSEEKER).grist(BUILD, 40).grist(RUST, 20).grist(CAULK, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.TERRAIN_FLATENATOR).grist(BUILD, 200).grist(RUST, 5).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.NOSFERATU_SPOON).grist(BUILD, 150).grist(MERCURY, 5).grist(AMETHYST, 20).grist(GARNET, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CROCKER_SPOON).grist(BUILD, 90).grist(IODINE, 34).grist(CHALK, 34).grist(RUBY, 6).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CROCKER_FORK).grist(BUILD, 90).grist(IODINE, 34).grist(CHALK, 34).grist(RUBY, 6).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CANDY_FORK).grist(BUILD, 50).grist(IODINE, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.TUNING_FORK).grist(BUILD, 25).grist(RUST, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.ELECTRIC_FORK).grist(BUILD, 40).grist(RUST, 75).grist(MERCURY, 50).grist(URANIUM, 50).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.EATING_FORK_GEM).grist(BUILD, 150).grist(IODINE, 55).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.DEVIL_FORK).grist(BUILD, 666).grist(SULFUR, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SKAIA_FORK).grist(BUILD, 900).grist(QUARTZ, 94).grist(GOLD, 58).grist(AMETHYST, 63).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.GOLDEN_SPORK).grist(BUILD, 70).grist(GOLD, 40).grist(DIAMOND, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BIDENT).grist(BUILD, 239).grist(GARNET, 50).grist(AMETHYST, 50).grist(QUARTZ, 30).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.BATLEACKS).grist(BUILD, 0).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.COPSE_CRUSHER).grist(BUILD, 25).grist(RUST, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.QUENCH_CRUSHER).grist(BUILD, 125).grist(IODINE, 34).grist(CAULK, 23).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.MELONSBANE).grist(BUILD, 245).grist(IODINE, 67).grist(CAULK, 63).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CROP_CHOP).grist(BUILD, 130).grist(IODINE, 93).grist(AMBER, 72).grist(GOLD, 45).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.THE_LAST_STRAW).grist(BUILD, 270).grist(GOLD, 124).grist(IODINE, 103).grist(AMBER, 95).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BATTLEAXE).grist(BUILD, 400).grist(RUST, 240).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CANDY_BATTLEAXE).grist(IODINE, 314).grist(GOLD, 240).grist(CHALK, 160).grist(AMBER, 98).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CHOCO_LOCO_WOODSPLITTER).grist(BUILD, 300).grist(IODINE, 265).grist(GOLD, 200).grist(CHALK, 120).grist(AMBER, 41).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.STEEL_EDGE_CANDYCUTTER).grist(BUILD, 500).grist(RUST, 413).grist(IODINE, 212).grist(GOLD, 167).grist(CHALK, 120).grist(AMBER, 43).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BLACKSMITH_BANE).grist(BUILD, 30).grist(RUST, 15).grist(TAR, 12).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.REGIAXE).grist(AMETHYST, 200).grist(TAR, 146).grist(GOLD, 98).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.GOTHY_AXE).grist(RUST, 180).grist(TAR, 146).grist(RUBY, 98).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SURPRISE_AXE).grist(BUILD, 170).grist(RUST, 80).grist(AMBER, 30).grist(IODINE, 12).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SHOCK_AXE).grist(BUILD, 275).grist(RUST, 125).grist(GOLD, 121).grist(AMBER, 90).grist(URANIUM, 50).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SCRAXE).grist(BUILD, 139).grist(TAR, 86).grist(RUST, 43).grist(RUBY, 8).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.LORENTZ_DISTRANSFORMATIONER).grist(BUILD, 150).grist(URANIUM, 20).grist(TAR, 20).grist(RUST, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.PISTON_POWERED_POGO_AXEHAMMER).grist(BUILD, 150).grist(SHALE, 64).grist(RUST, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.RUBY_CROAK).grist(BUILD, 900).grist(GARNET, 103).grist(RUBY, 64).grist(DIAMOND, 16).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.HEPHAESTUS_LUMBERJACK).grist(BUILD, 625).grist(GOLD, 49).grist(RUBY, 36).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.FISSION_FOCUSED_FAULT_FELLER).grist(BUILD, 800).grist(SHALE, 128).grist(URANIUM, 64).grist(RUST, 30).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BISECTOR).grist(BUILD, 239).grist(GARNET, 5).grist(AMETHYST, 5).grist(QUARTZ, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.FINE_CHINA_AXE).grist(MARBLE, 150).grist(SHALE, 50).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.REGISICKLE).grist(AMETHYST, 25).grist(TAR, 57).grist(GOLD, 33).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SICKLE).grist(BUILD, 8).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BISICKLE).grist(BUILD, 30).grist(RUST, 10).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.THORNY_SUBJECT).grist(BUILD, 96).grist(AMETHYST, 14).grist(RUBY, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.OW_THE_EDGE).grist(ARTIFACT, -25).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.HOMES_SMELL_YA_LATER).grist(BUILD, 34).grist(AMBER, 19).grist(AMETHYST, 10).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.HEMEOREAPER).grist(BUILD, 143).grist(RUST, 66).grist(GARNET, 43).grist(IODINE, 21).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.HERETICUS_AURURM).grist(GOLD, 200).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.FUDGESICKLE).grist(IODINE, 23).grist(AMBER, 15).grist(CHALK, 12).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CLAW_SICKLE).grist(BUILD, 255).grist(IODINE, 103).grist(CHALK, 56).grist(GARNET, 6).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CLAW_OF_NRUBYIGLITH).grist(BUILD, 333).grist(AMETHYST, 80).grist(CHALK, 6).grist(GARNET, 6).grist(SHALE, 6).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CANDY_SICKLE).grist(IODINE, 65).grist(GOLD, 38).grist(CHALK, 53).grist(AMBER, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SCYTHE).grist(BUILD, 30).grist(RUST, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.EIGHTBALL_SCYTHE).grist(BUILD, 100).grist(TAR, 40).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.STALE_BAGUETTE).grist(IODINE, 15).grist(AMBER, 11).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.GLUB_CLUB).grist(BUILD, 35).grist(CAULK, 15).grist(AMBER, 14).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.NIGHT_CLUB).grist(TAR, 28).grist(SHALE, 19).grist(COBALT, 6).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.NIGHTSTICK).grist(TAR, 60).grist(MARBLE, 30).grist(GOLD, 6).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.PRISMARINE_BASHER).grist(BUILD, 75).grist(COBALT, 45).grist(MARBLE, 22).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CLUB_ZERO).grist(BUILD, 64).grist(COBALT, 35).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.POGO_CLUB).grist(BUILD, 15).grist(SHALE, 12).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BARBER_BASHER).grist(BUILD, 80).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.METAL_BAT).grist(BUILD, 35).grist(MERCURY, 23).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SPIKED_CLUB).grist(BUILD, 46).grist(GARNET, 38).grist(IODINE, 13).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CLOWN_CLUB).grist(BUILD, 150).grist(MERCURY, 20).grist(COBALT, 20).grist(IODINE, 15).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.MACE).grist(BUILD, 130).grist(RUST, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.M_ACE).grist(BUILD, 200).grist(MARBLE, 10).grist(CHALK, 22).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.BLAZING_GLORY).grist(BUILD, 250).grist(SULFUR, 10).grist(GOLD, 5).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.VAUDEVILLE_HOOK).grist(IODINE, 8).grist(TAR, 4).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.UPPER_CRUST_CRUST_CANE).grist(BUILD, 50).grist(IODINE, 35).grist(AMBER, 19).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SPEAR_CANE).grist(BUILD, 28).grist(MERCURY, 14).grist(AMBER, 11).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.PARADISES_PORTABELLO).grist(BUILD, 40).grist(IODINE, 30).grist(RUBY, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.REGI_CANE).grist(AMETHYST, 30).grist(TAR, 55).grist(GOLD, 32).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.POGO_CANE).grist(BUILD, 18).grist(SHALE, 14).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.URANIUM_POWERED_STICK).grist(URANIUM, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.CANDY_CANE).grist(IODINE, 65).grist(CHALK, 53).grist(AMBER, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.SHARP_CANDY_CANE).grist(IODINE, 65).grist(CHALK, 53).grist(AMBER, 20).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.PRIM_AND_PROPER_WALKING_POLE).grist(BUILD, 60).grist(IODINE, 54).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.LESS_PROPER_WALKING_STICK).grist(BUILD, 500).grist(RUST, 120).grist(IODINE, 45).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.ROCKEFELLERS_WALKING_BLADECANE).grist(BUILD, 2222).grist(RUST, 222).grist(TAR, 22).grist(DIAMOND, 2).grist(RUBY, 1).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.DRAGON_CANE).grist(BUILD, 1777).grist(RUBY, 777).grist(RUST, 777).grist(CHALK, 277).build(recipeSaver);
		
		WeaponGristCostRecipeBuilder.of(MSItems.NEEDLE_WAND).grist(DIAMOND, 20).grist(CHALK, 30).grist(GARNET, 40).grist(GOLD, 16).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.ARTIFUCKER).grist(ARTIFACT, -100).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.POINTER_WAND).grist(BUILD, 200).grist(CAULK, 40).grist(AMBER, 50).grist(RUST, 30).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.POOL_CUE_WAND).grist(QUARTZ, 50).grist(CHALK, 70).grist(TAR, 90).grist(URANIUM, 45).build(recipeSaver);
		WeaponGristCostRecipeBuilder.of(MSItems.THORN_OF_OGLOGOTH).grist(IODINE, 200).grist(CHALK, 160).grist(AMETHYST, 120).grist(GOLD, 100).grist(TAR, 64).build(recipeSaver);
