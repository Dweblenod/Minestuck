...
import com.mraof.minestuck.item.weapon.FluoriteWeaponItem;
...
public class MinestuckEnUsLanguageProvider extends MinestuckLanguageProvider
{
	...
	protected void addTranslations()
	{
		...
		addExtra(MSItems.FLUORITE_OCTET, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_OCTET, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_OCTET, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_OCTET, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_OCTET, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_OCTET, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_OCTET, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_OCTET, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_WEASEL, "Fluorite Weasel");
		addExtra(MSItems.FLUORITE_WEASEL, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_WEASEL, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_WEASEL, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_WEASEL, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_WEASEL, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_WEASEL, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_WEASEL, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_WEASEL, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_MUSCLEBEAST, "Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_MUSCLEBEAST, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_GARROTE, "Fluorite Garrote");
		addExtra(MSItems.FLUORITE_GARROTE, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_GARROTE, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_GARROTE, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_GARROTE, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_GARROTE, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_GARROTE, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_GARROTE, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_GARROTE, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_KNUCKLES, "Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_KNUCKLES, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_KNIFE, "Fluorite Knife");
		addExtra(MSItems.FLUORITE_KNIFE, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_KNIFE, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_KNIFE, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_KNIFE, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_KNIFE, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_KNIFE, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_KNIFE, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_KNIFE, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_MACE, "Fluorite Mace");
		addExtra(MSItems.FLUORITE_MACE, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_MACE, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_MACE, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_MACE, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_MACE, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_MACE, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_MACE, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_MACE, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_GUILLOTINE, "Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_GUILLOTINE, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
		add(MSItems.FLUORITE_SWORD, "Fluorite Ancestor Sword");
		addExtra(MSItems.FLUORITE_SWORD, "message.1", "Rolled a 1! Fluorite Weasel");
		addExtra(MSItems.FLUORITE_SWORD, "message.2", "Rolled a 2! Fluorite Musclebeast Statue");
		addExtra(MSItems.FLUORITE_SWORD, "message.3", "Rolled a 3! Fluorite Garrote");
		addExtra(MSItems.FLUORITE_SWORD, "message.4", "Rolled a 4! Fluorite Knuckles");
		addExtra(MSItems.FLUORITE_SWORD, "message.5", "Rolled a 5! Fluorite Knife");
		addExtra(MSItems.FLUORITE_SWORD, "message.6", "Rolled a 6! Fluorite Mace");
		addExtra(MSItems.FLUORITE_SWORD, "message.7", "Rolled a 7! Fluorite Guillotine Blade");
		addExtra(MSItems.FLUORITE_SWORD, "message.8", "Rolled an 8! Fluorite Ancestor Sword");
