...
public class MassiveMushroomFeature extends BigBrownMushroomFeature {
    public MassiveMushroomFeature(Function<Dynamic<?>, ? extends BigMushroomFeatureConfig> p_i49864_1_) {
        super(p_i49864_1_);
    }
