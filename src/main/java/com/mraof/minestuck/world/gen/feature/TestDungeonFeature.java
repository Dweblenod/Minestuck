...
public class TestDungeonFeature extends Feature<NoFeatureConfig>
{
    private static final ResourceLocation END_DUNGEON = new ResourceLocation(Minestuck.MOD_ID, "prospit_dream_tower_floor1_sw");

    public TestDungeonFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn)
    {
    ...
    public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, NoFeatureConfig config)
    {
        ...
        Template template = templates.getTemplateDefaulted(END_DUNGEON);
